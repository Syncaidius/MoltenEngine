...
namespace Molten.Graphics
{
    public class Texture1DGL : TextureBaseGL, ITexture
    {
        ...
        protected unsafe override void CreateResource(ref int id, TextureTarget target, bool isResizing)
        {
            ...
            for (int i = 0; i < MipMapCount; i++)
                GL.TexImage1D(target, i, Format.ToPixelInternal(), Width, 0, PixelFormat.Rgba, PixelType.UnsignedByte, IntPtr.Zero);
        }
    }
}
