...
{
    public abstract class VertexBufferDX11 : GraphicsBuffer, IVertexBuffer
    {
        protected VertexBufferDX11(DeviceDX11 device, BufferMode mode, uint stride, uint numElements, Array initialData = null) :
