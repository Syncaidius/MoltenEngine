...
namespace Molten.Graphics
{
    internal partial class RenderChainContext : IPoolable
    {
        ...
        /// <summary>
        /// Gets or sets the <see cref="DeviceContext"/> that is processing the current render chain.
        /// </summary>
        //internal DeviceContext Context { get; set; }

        internal StateConditions BaseStateConditions { get; set; }

        /// <summary>
        /// Gets or sets the <see cref="DeviceContext"/> that is processing the current chain.
        /// </summary>
        internal DeviceContext Context { get; set; }
    }
}
