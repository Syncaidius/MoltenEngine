...
namespace Molten.Graphics
{
    internal class LightingStep : RenderStep
    {
        ...
        internal override void Initialize(RenderService renderer)
        {
            ...
            _lightBuffer = renderer.Device.CreateStructuredBuffer<LightData>(GraphicsResourceFlags.CpuWrite | GraphicsResourceFlags.GpuRead | GraphicsResourceFlags.Ring, maxLights, false, true);
