...
public class GpuStateBasicValueGroup<T>
    where T : GpuObject
{
    T[] _values;
    T[] _boundValues;
    ...
    public GpuStateBasicValueGroup(uint capacity, Action<T, int> validationCallback = null)
    {
    ...
    public void CopyTo(GpuStateBasicValueGroup<T> target)
    {
