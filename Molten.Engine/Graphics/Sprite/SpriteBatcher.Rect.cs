...
public partial class SpriteBatcher
{
    ...
    public void DrawRect(RectangleF destination, Color color, float rotation = 0, Shader shader = null, uint surfaceSlice = 0)
    {
    ...
    /// <param name="color">The color of the rectangle. Overrides the <see cref="SpriteStyle.PrimaryColor"/> of the current <see cref="SpriteStyle"/>.</param>
    /// <param name="shader">The shader to apply to the rectangle. A value of null will use the default sprite-batch material.</param>
    public void DrawRect(RectangleF destination, Color color, Vector2F origin, float rotation = 0, Shader shader = null, uint surfaceSlice = 0)
    {
        _rectStyle.FillColor = color;
        _rectStyle.BorderThickness.Zero();
    ...
    /// <param name="destination">The rectangle defining the draw destination.</param>
    /// <param name="shader">The shader to apply to the rectangle. A value of null will use the default sprite-batch material.</param>
    public void DrawRect(RectangleF destination, ref RectStyle style, float rotation = 0, Shader shader = null, uint surfaceSlice = 0)
    {
    ...
    public void DrawRect(RectangleF destination, float rotation, Vector2F origin, ref RectStyle style, Shader shader = null, uint surfaceSlice = 0)
    {
