...
namespace Molten.Graphics
{
    public abstract partial class SpriteBatcher
    {
        ...
        public void DrawRect(RectangleF destination, Color color, float rotation = 0, IMaterial material = null)
        {
            ...
            Draw(null, RectangleF.Empty, destination.TopLeft, destination.Size, rotation, Vector2F.Zero, ref _rectStyle, material, 0);
        }
        ...
        public void DrawRect(RectangleF destination, Color color, Vector2F origin, float rotation = 0, IMaterial material = null)
        {
            ...
            Draw(null, RectangleF.Empty, destination.TopLeft, 
                destination.Size, rotation, origin, ref _rectStyle, material, 0);
        }

        /// <summary>Adds an untextured rectangle to the <see cref="SpriteBatch"/>.</summary>
        /// <param name="destination">The rectangle defining the draw destination.</param>
        /// <param name="material">The material to apply to the rectangle. A value of null will use the default sprite-batch material.</param>
        public void DrawRect(RectangleF destination, ref RectStyle style, float rotation = 0, IMaterial material = null)
        {
            Draw(null, RectangleF.Empty, destination.TopLeft, destination.Size, rotation, Vector2F.Zero, ref style, material, 0);
        }
        ...
        public void DrawRect(RectangleF destination, float rotation, Vector2F origin, ref RectStyle style, IMaterial material = null)
        {
            Draw(null, RectangleF.Empty, destination.TopLeft, destination.Size, rotation, origin, ref style, material, 0);
        }
    }
}
