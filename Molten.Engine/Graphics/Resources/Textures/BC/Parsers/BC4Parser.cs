...
{
    public override GpuResourceFormat ExpectedFormat => GpuResourceFormat.BC4_UNorm;
...
{
    public override GpuResourceFormat ExpectedFormat => GpuResourceFormat.BC4_SNorm;
