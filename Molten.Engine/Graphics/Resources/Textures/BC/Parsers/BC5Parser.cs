...
{
    public override GpuResourceFormat ExpectedFormat => GpuResourceFormat.BC5_UNorm;
...
{
    public override GpuResourceFormat ExpectedFormat => GpuResourceFormat.BC5_SNorm;
