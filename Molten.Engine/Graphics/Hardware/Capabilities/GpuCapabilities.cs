...
public sealed partial class GpuCapabilities
{   
    ...
    /// <summary>
    /// Sets a shader property across all <see cref="ShaderStageCapabilities"/> in the current <see cref="GpuCapabilities"/> instance.
    ...
    public bool IsCompatible(GpuCapabilities other)
    {
    ...
    public void LogIncompatibility(Logger log, GpuCapabilities other)
    {
    ...
    /// </summary>
    public GpuCapFlags Flags { get; set; }
}
