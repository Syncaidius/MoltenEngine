...
namespace Molten.UI
{
    public partial class UITextArea : UICompoundComponent
    {
        ...
        {
            return _ui.Engine.Input.Keyboard.IsPressed(Key.LeftShift) && !_ui.Engine.Input.Keyboard.IsPressed(Key.RightShift);
        }
        ...
        private void DoSystemKeyAction(Schedule time, Action action)
        {
        ...
        private void DoPageKey(Schedule time, int multiplier)
        {
