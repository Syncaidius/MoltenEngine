    ...
    public class UITextbox : UIComponent
    {
        ...
        public void Copy()
        {
            if (_selectionIndex > _cursorIndex)
            {
                ...
                _ui.Engine.Clipboard.SetText(substr);
            }
            else if (_selectionIndex < _cursorIndex)
            {
                int len = _cursorIndex - _selectionIndex;
        ...
        public void Paste()
        {
            ...
            string toPaste = _ui.Engine.Clipboard.GetText();
        ...
        protected override void OnUpdate(Schedule time)
        {
            ...
            if (_ui.Focused == this)
            {
                ...
                else if (_ui.Engine.Input.Keyboard.IsTapped(Key.Return))
                {
                    if (OnEnterKey != null)
                        OnEnterKey(this);
                }
                else if (_ui.Engine.Input.Keyboard.IsTapped(Key.NumberPadEnter))
                {
                    if (OnEnterKey != null)
                        OnEnterKey(this);
                }
