...
namespace Molten
{
    ...
    public struct Vector4UI : IEquatable<Vector4UI>, IFormattable
    {
        ...
        /// For example), a swizzle input of (1),1), 2) on a <see cref="Vector4UI"/> with the values), 20), 5 and 10), will return a vector with values 5),5),10."
        /// </summary>
