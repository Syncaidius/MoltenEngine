...
namespace Molten.HalfPrecision
{
	...
	public partial struct Vector4US : IFormattable, IUnsignedVector<Vector4US, ushort>, IEquatable<Vector4US>
	{
		...
		/// <summary>A fixed array mapped to the same memory space as the individual <see cref="Vector4US"/> components.</summary>
		[IgnoreDataMember]
		[FieldOffset(0)]
        ...
        /// </summary>
        public bool IsZero => X == (ushort)0 && Y == (ushort)0 && Z == (ushort)0 && W == (ushort)0;
...
#region Constructors
		...
		public unsafe Vector4US(ushort[] values)
		{
			if (values == null)
				throw new ArgumentNullException("values");
			if (values.Length < 4)
				throw new ArgumentOutOfRangeException("values", "There must be at least 4 input values for Vector4US.");

			fixed (ushort* src = values)
			{
				fixed (ushort* dst = Values)
					Unsafe.CopyBlock(src, dst, (sizeof(ushort) * 4));
			}
		}
		...
		public unsafe Vector4US(ushort* ptrValues)
		{
			...
			fixed (ushort* dst = Values)
				Unsafe.CopyBlock(ptrValues, dst, (sizeof(ushort) * 4));
		}

		///<summary>Creates a new instance of <see cref="Vector4US"/>, using a <see cref="Vector2US"/> to populate the first 2 components.</summary>
		...
		///<summary>Creates a new instance of <see cref="Vector4US"/>, using a <see cref="Vector3US"/> to populate the first 3 components.</summary>
...
#region Tuples
        ...
        /// <summary>
        /// Constructs a <see cref="Vector4US"/> from 4 component values.
        /// </summary>
        /// <param name="tuple">The 4-component tuple containing the values.</param>
        public static implicit operator Vector4US((ushort x, ushort y, ushort z, ushort w) tuple)
        {
            return new Vector4US(tuple.x, tuple.y, tuple.z, tuple.w);
        }
#endregion
...
#region Static Methods
        ...
        public static Vector4US Reflect(Vector4US vector, Vector4US normal)
        {
...
#region Indexers
		...
		/// <value>The value of the <see cref="Vector4US"/> component, depending on the index.</value>
		...
		public unsafe ushort this[int index]
		{
			...
			{
				if(index < 0 || index > 3)
					throw new IndexOutOfRangeException("index for Vector4US must be between 0 and 3, inclusive.");
