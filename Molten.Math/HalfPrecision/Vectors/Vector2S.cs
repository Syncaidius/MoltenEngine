...
#region Indexers
	...
	/// <value>The value of the <see cref="Vector2S"/> component, depending on the index.</value>
	...
	public unsafe short this[int index]
	{
		...
		{
			if(index < 0 || index > 1)
				throw new IndexOutOfRangeException("index for Vector2S must be between 0 and 1, inclusive.");
