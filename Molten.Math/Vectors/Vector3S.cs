...
#region Add operators
		...
		{
			return new Vector3S(left.X + right, left.Y + right, left.Z + right);
		}
...
#region Multiply operators
		...
		{
			return new Vector3S(left * right.X, left * right.Y, left * right.Z);
		}
#endregion
...
#region Static Methods
        ...
        public static Vector3S SmoothStep(ref Vector3S start, ref Vector3S end, short amount)
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="source"/> or <paramref name="destination"/> is <c>null</c>.</exception>
        /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="destination"/> is shorter in length than <paramref name="source"/>.</exception>
        public static void Orthonormalize(Vector3S[] destination, params Vector3S[] source)
        {
            //Uses the modified Gram-Schmidt process.
        ...
        /// <summary>
        /// Converts the <see cref="Vector3S"/> into a unit vector.
        /// </summary>
        /// <param name="value">The <see cref="Vector3S"/> to normalize.</param>
        /// <returns>The normalized <see cref="Vector3S"/>.</returns>
