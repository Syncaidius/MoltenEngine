...
#region Static Methods
        ...
        public static Vector3UI SmoothStep(ref Vector3UI start, ref Vector3UI end, uint amount)
        {
        ...
        /// <param name="amount">Weighting factor.</param>
        public static Vector3UI CatmullRom(ref Vector3UI value1, ref Vector3UI value2, ref Vector3UI value3, ref Vector3UI value4, uint amount)
        {
            float squared = amount * amount;
            float cubed = amount * squared;
        ...
        public static Vector3UI CatmullRom(Vector3UI value1, Vector3UI value2, Vector3UI value3, Vector3UI value4, uint amount)
        {
