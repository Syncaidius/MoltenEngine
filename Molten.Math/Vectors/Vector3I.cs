...
#region Static Methods
        ...
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="source"/> or <paramref name="destination"/> is <c>null</c>.</exception>
        /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="destination"/> is shorter in length than <paramref name="source"/>.</exception>
        public static void Orthonormalize(Vector3I[] destination, params Vector3I[] source)
        {
            //Uses the modified Gram-Schmidt process.
        ...
        /// <param name="min">The minimum value of each component.</param>
        /// <param name="max">The maximum value of each component.</param>
        public static Vector3I Clamp(ref Vector3I value, ref Vector3I min, ref Vector3I max, out Vector3I result)
        {
        ...
        /// <summary>
        /// Converts the <see cref="Vector3I"/> into a unit vector.
        /// </summary>
        /// <param name="value">The <see cref="Vector3I"/> to normalize.</param>
        /// <returns>The normalized <see cref="Vector3I"/>.</returns>
