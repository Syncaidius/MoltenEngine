...
#region Multiply operators
		...
		{
			return new Vector4I(left * right.X, left * right.Y, left * right.Z, left * right.W);
		}
#endregion
...
#region Static Methods
        ...
        public static Vector4I SmoothStep(ref Vector4I start, ref Vector4I end, int amount)
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="source"/> or <paramref name="destination"/> is <c>null</c>.</exception>
        /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="destination"/> is shorter in length than <paramref name="source"/>.</exception>
        public static void Orthonormalize(Vector4I[] destination, params Vector4I[] source)
        {
            //Uses the modified Gram-Schmidt process.
        ...
        /// </summary>
        /// <param name="value1">First source position <see cref="Vector4I"/> vector.</param>
        /// <param name="tangent1">First source tangent <see cref="Vector4I"/> vector.</param>
        /// <param name="value2">Second source position <see cref="Vector4I"/> vector.</param>
        /// <param name="tangent2">Second source tangent <see cref="Vector4I"/> vector.</param>
        /// <param name="amount">Weighting factor.</param>
        public static Vector4I Hermite(ref Vector4I value1, ref Vector4I tangent1, ref Vector4I value2, ref Vector4I tangent2, int amount)
        {
			...
			return new Vector4I()
			{
				...
				W = (int)((((value1.W * part1) + (value2.W * part2)) + (tangent1.W * part3)) + (tangent2.W * part4)),
			};
        }
        ...
        /// Performs a Hermite spline interpolation.
        /// </summary>
        /// <param name="value1">First source position <see cref="Vector4I"/>.</param>
        /// <param name="tangent1">First source tangent <see cref="Vector4I"/>.</param>
        /// <param name="value2">Second source position <see cref="Vector4I"/>.</param>
        /// <param name="tangent2">Second source tangent <see cref="Vector4I"/>.</param>
        /// <param name="amount">Weighting factor.</param>
        /// <returns>The result of the Hermite spline interpolation.</returns>
        public static Vector4I Hermite(Vector4I value1, Vector4I tangent1, Vector4I value2, Vector4I tangent2, int amount)
        {
        ...
        /// <param name="amount">Weighting factor.</param>
        public static Vector4I CatmullRom(ref Vector4I value1, ref Vector4I value2, ref Vector4I value3, ref Vector4I value4, int amount)
        {
            float squared = amount * amount;
            float cubed = amount * squared;
        ...
        public static Vector4I CatmullRom(Vector4I value1, Vector4I value2, Vector4I value3, Vector4I value4, int amount)
        {
        ...
        /// <summary>
        /// Converts the <see cref="Vector4I"/> into a unit vector.
        /// </summary>
        /// <param name="value">The <see cref="Vector4I"/> to normalize.</param>
        /// <returns>The normalized <see cref="Vector4I"/>.</returns>
