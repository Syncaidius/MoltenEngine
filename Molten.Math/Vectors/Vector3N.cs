...
#region Common Functions
        ...
        /// <param name="result">When the method completes, contains the dot product of the two <see cref="Vector3N"/> vectors.</param>
...
#region Static Methods
        ...
        /// <param name="vec">The Vector3N to be truncated.</param>
        /// <returns></returns>
        public static Vector3N Truncate(Vector3N value)
        {
            return new Vector3N()
            {
