...
#region Static Methods
        ...
        public static bool NearEqual(Vector2N left, Vector2N right, Vector2N epsilon)
        {
        ...
        /// <param name="epsilon">The epsilon.</param>
        /// <returns><c>true</c> if left and right are near another 3D, <c>false</c> otherwise</returns>
        public static bool NearEqual(ref Vector2N left, ref Vector2N right, ref Vector2N epsilon)
        {
        ...
        /// <remarks>
        /// <see cref="Vector2N.DistanceSquared(Vector2N, Vector2N)"/> may be preferred when only the relative distance is needed
        /// and speed is of the essence.
        /// </remarks>
        ...
        public static nint Dot(ref Vector2N left, ref Vector2N right)
        {
        ...
        /// provides the same information and avoids calculating two square roots.
        /// </remarks>
		public static nint DistanceSquared(Vector2N value1, Vector2N value2)
        {
            nint x = value1.X - value2.X;
            nint y = value1.Y - value2.Y;
