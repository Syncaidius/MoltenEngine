...
#region Instance Methods
        ...
        /// </summary>
        /// <param name="other">The <see cref="Vector4N"/> to compare with this instance.</param>
        /// <returns>
        /// 	<c>true</c> if the specified <see cref="Vector4N"/> is equal to this instance; otherwise, <c>false</c>.
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(ref Vector4N other)
        {
        ...
        /// Determines whether the specified <see cref="Vector4N"/> is equal to this instance.
        /// </summary>
        /// <param name="value">The <see cref="Vector4N"/> to compare with this instance.</param>
        /// <returns>
        /// 	<c>true</c> if the specified <see cref="Vector4N"/> is equal to this instance; otherwise, <c>false</c>.
        /// </returns>
        public override bool Equals(object value)
        {
            if (!(value is Vector4N))
                return false;

            var strongValue = (Vector4N)value;
...
#region Multiply operators
        ...
        public static Vector4N operator *(nint left, Vector4N right)
		{
			return new Vector4N(left * right.X, left * right.Y, left * right.Z, left * right.W);
		}
#endregion
...
#region Operators - Cast
        ///<summary>Casts a <see cref="Vector4N"/> to a <see cref="Vector2N"/>.</summary>
        public static explicit operator Vector2N(Vector4N value)
        {
            return new Vector2N(value.X, value.Y);
        }

        ///<summary>Casts a <see cref="Vector4N"/> to a <see cref="Vector3N"/>.</summary>
        public static explicit operator Vector3N(Vector4N value)
        {
...
#region Static Methods
        ...
        public static Vector4N SmoothStep(ref Vector4N start, ref Vector4N end, nint amount)
        {
        ...
        public static Vector4N SmoothStep(Vector4N start, Vector4N end, nint amount)
        {
            return SmoothStep(ref start, ref end, amount);
        }    

        /// <summary>
        /// Orthogonalizes a list of <see cref="Vector4N"/>.
        /// </summary>
        /// <param name="destination">The list of orthogonalized <see cref="Vector4N"/>.</param>
        ...
        public static void Orthogonalize(Vector4N[] destination, params Vector4N[] source)
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="source"/> or <paramref name="destination"/> is <c>null</c>.</exception>
        /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="destination"/> is shorter in length than <paramref name="source"/>.</exception>
        public static void Orthonormalize(Vector4N[] destination, params Vector4N[] source)
        {
            //Uses the modified Gram-Schmidt process.
        ...
        /// <summary>
        /// Takes the value of an indexed component and assigns it to the axis of a new <see cref="Vector4N"/>. <para />
        /// For example, a swizzle input of (1,1) on a <see cref="Vector4N"/> with the values, 20 and 10, will return a vector with values 10,10, because it took the value of component index 1, for both axis."
        /// </summary>
        ...
        /// <returns></returns>
        public static unsafe Vector4N Swizzle(Vector4N val, int xIndex, int yIndex, int zIndex, int wIndex)
        {
            return new Vector4N()
            {
			   X = (&val.X)[xIndex],
        ...
        /// <returns></returns>
        public static unsafe Vector4N Swizzle(Vector4N val, uint xIndex, uint yIndex, uint zIndex, uint wIndex)
        {
            return new Vector4N()
            {
			    X = (&val.X)[xIndex],
        ...
        public static nint Dot(ref Vector4N left, ref Vector4N right)
        {
        ...
        /// Performs a Hermite spline interpolation.
        /// </summary>
        /// <param name="value1">First source position <see cref="Vector4N"/>.</param>
        /// <param name="tangent1">First source tangent <see cref="Vector4N"/>.</param>
        /// <param name="value2">Second source position <see cref="Vector4N"/>.</param>
        /// <param name="tangent2">Second source tangent <see cref="Vector4N"/>.</param>
        /// <param name="amount">Weighting factor.</param>
        /// <returns>The result of the Hermite spline interpolation.</returns>
        public static Vector4N Hermite(Vector4N value1, Vector4N tangent1, Vector4N value2, Vector4N tangent2, nint amount)
        {
        ...
        /// <param name="amount">Weighting factor.</param>
        public static Vector4N CatmullRom(ref Vector4N value1, ref Vector4N value2, ref Vector4N value3, ref Vector4N value4, nint amount)
        {
            float squared = amount * amount;
            float cubed = amount * squared;
        ...
        public static Vector4N CatmullRom(Vector4N value1, Vector4N value2, Vector4N value3, Vector4N value4, nint amount)
        {
        ...
        public static Vector4N Reflect(ref Vector4N vector, ref Vector4N normal)
        {
            nint dot = (vector.X * normal.X) + (vector.Y * normal.Y) + (vector.Z * normal.Z) + (vector.W * normal.W);
        ...
        /// <summary>
        /// Converts the <see cref="Vector4N"/> into a unit vector.
        /// </summary>
        /// <param name="value">The <see cref="Vector4N"/> to normalize.</param>
        /// <returns>The normalized <see cref="Vector4N"/>.</returns>
        public static Vector4N Normalize(Vector4N value)
        {
            value.Normalize();
            return value;
        }
