...
#region Subtract operators
		...
		/// <summary>
        /// Negate/reverse the direction of a <see cref="Vector3US"/>.
        /// </summary>
        /// <param name="value">The <see cref="Vector3US"/> to reverse.</param>
...
#region Static Methods
        ...
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="source"/> or <paramref name="destination"/> is <c>null</c>.</exception>
        /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="destination"/> is shorter in length than <paramref name="source"/>.</exception>
        public static void Orthonormalize(Vector3US[] destination, params Vector3US[] source)
        {
            //Uses the modified Gram-Schmidt process.
        ...
        /// <param name="amount">Weighting factor.</param>
        public static Vector3US CatmullRom(ref Vector3US value1, ref Vector3US value2, ref Vector3US value3, ref Vector3US value4, ushort amount)
        {
            float squared = amount * amount;
            float cubed = amount * squared;
        ...
        public static Vector3US CatmullRom(Vector3US value1, Vector3US value2, Vector3US value3, Vector3US value4, ushort amount)
        {
        ...
        /// <summary>
        /// Converts the <see cref="Vector3US"/> into a unit vector.
        /// </summary>
        /// <param name="value">The <see cref="Vector3US"/> to normalize.</param>
        /// <returns>The normalized <see cref="Vector3US"/>.</returns>
        public static Vector3US Normalize(Vector3US value)
        {
            value.Normalize();
            return value;
        }
