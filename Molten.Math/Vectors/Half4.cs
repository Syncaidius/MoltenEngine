...
#region Multiply operators
        ...
        public static Half4 operator *(short left, Half4 right)
		{
			return new Half4(left * right.X, left * right.Y, left * right.Z, left * right.W);
		}
#endregion
...
#region Static Methods
        ...
        public static bool NearEqual(Half4 left, Half4 right, Half4 epsilon)
        {
        ...
        /// <param name="epsilon">The epsilon.</param>
        /// <returns><c>true</c> if left and right are near another 3D, <c>false</c> otherwise</returns>
        public static bool NearEqual(ref Half4 left, ref Half4 right, ref Half4 epsilon)
        {
        ...
        public static Half4 SmoothStep(ref Half4 start, ref Half4 end, short amount)
        {
        ...
        public static Half4 SmoothStep(Half4 start, Half4 end, short amount)
        {
            return SmoothStep(ref start, ref end, amount);
        }    

        /// <summary>
        /// Orthogonalizes a list of <see cref="Half4"/>.
        /// </summary>
        /// <param name="destination">The list of orthogonalized <see cref="Half4"/>.</param>
        ...
        public static void Orthogonalize(Half4[] destination, params Half4[] source)
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="source"/> or <paramref name="destination"/> is <c>null</c>.</exception>
        /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="destination"/> is shorter in length than <paramref name="source"/>.</exception>
        public static void Orthonormalize(Half4[] destination, params Half4[] source)
        {
            //Uses the modified Gram-Schmidt process.
        ...
        /// For example, a swizzle input of (1,1) on a <see cref="Half4"/> with the values, 20 and 10, will return a vector with values 10,10, because it took the value of component index 1, for both axis."
        /// </summary>
        ...
        /// <remarks>
        /// <see cref="Half4.DistanceSquared(Half4, Half4)"/> may be preferred when only the relative distance is needed
        /// and speed is of the essence.
        /// </remarks>
        ...
        public static short Dot(ref Half4 left, ref Half4 right)
        {
        ...
        /// Performs a Hermite spline interpolation.
        /// </summary>
        /// <param name="value1">First source position <see cref="Half4"/>.</param>
        /// <param name="tangent1">First source tangent <see cref="Half4"/>.</param>
        /// <param name="value2">Second source position <see cref="Half4"/>.</param>
        /// <param name="tangent2">Second source tangent <see cref="Half4"/>.</param>
        /// <param name="amount">Weighting factor.</param>
        /// <returns>The result of the Hermite spline interpolation.</returns>
        public static Half4 Hermite(Half4 value1, Half4 tangent1, Half4 value2, Half4 tangent2, short amount)
        {
        ...
        /// provides the same information and avoids calculating two square roots.
        /// </remarks>
		public static short DistanceSquared(Half4 value1, Half4 value2)
        {
            short x = value1.X - value2.X;
            short y = value1.Y - value2.Y;
            short z = value1.Z - value2.Z;
        ...
        /// <param name="amount">Weighting factor.</param>
        public static Half4 CatmullRom(ref Half4 value1, ref Half4 value2, ref Half4 value3, ref Half4 value4, short amount)
        {
            float squared = amount * amount;
            float cubed = amount * squared;
        ...
        public static Half4 CatmullRom(Half4 value1, Half4 value2, Half4 value3, Half4 value4, short amount)
        {
        ...
        public static Half4 Reflect(ref Half4 vector, ref Half4 normal)
        {
        ...
        /// <summary>
        /// Converts the <see cref="Half4"/> into a unit vector.
        /// </summary>
        /// <param name="value">The <see cref="Half4"/> to normalize.</param>
        /// <returns>The normalized <see cref="Half4"/>.</returns>
