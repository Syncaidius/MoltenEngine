...
#region Instance Methods
        /// <summary>
        /// Determines whether the specified <see cref="Half3"/> is equal to this instance.
        /// </summary>
        /// <param name="other">The <see cref="Half3"/> to compare with this instance.</param>
        /// <returns>
        /// 	<c>true</c> if the specified <see cref="Half3"/> is equal to this instance; otherwise, <c>false</c>.
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(ref Half3 other)
        {
        ...
        /// Determines whether the specified <see cref="Half3"/> is equal to this instance.
        /// </summary>
        /// <param name="value">The <see cref="Half3"/> to compare with this instance.</param>
        /// <returns>
        /// 	<c>true</c> if the specified <see cref="Half3"/> is equal to this instance; otherwise, <c>false</c>.
        /// </returns>
...
#region Multiply operators
        ...
        public static Half3 operator *(short left, Half3 right)
		{
			return new Half3(left * right.X, left * right.Y, left * right.Z);
		}
#endregion
...
#region Operators - Cast
        ///<summary>Casts a <see cref="Half3"/> to a <see cref="Vector2"/>.</summary>
        public static explicit operator Vector2(Half3 value)
        {
            return new Vector2(value.X, value.Y);
        }

        ///<summary>Casts a <see cref="Half3"/> to a <see cref="Vector4"/>.</summary>
        public static explicit operator Vector4(Half3 value)
        {
...
#region Static Methods
        ...
        public static bool NearEqual(Half3 left, Half3 right, Half3 epsilon)
        {
        ...
        /// <param name="epsilon">The epsilon.</param>
        /// <returns><c>true</c> if left and right are near another 3D, <c>false</c> otherwise</returns>
        public static bool NearEqual(ref Half3 left, ref Half3 right, ref Half3 epsilon)
        {
        ...
        public static Half3 SmoothStep(ref Half3 start, ref Half3 end, short amount)
        {
        ...
        public static Half3 SmoothStep(Half3 start, Half3 end, short amount)
        {
            return SmoothStep(ref start, ref end, amount);
        }    

        /// <summary>
        /// Orthogonalizes a list of <see cref="Half3"/>.
        /// </summary>
        /// <param name="destination">The list of orthogonalized <see cref="Half3"/>.</param>
        ...
        public static void Orthogonalize(Half3[] destination, params Half3[] source)
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="source"/> or <paramref name="destination"/> is <c>null</c>.</exception>
        /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="destination"/> is shorter in length than <paramref name="source"/>.</exception>
        public static void Orthonormalize(Half3[] destination, params Half3[] source)
        {
            //Uses the modified Gram-Schmidt process.
        ...
        /// <summary>
        /// Takes the value of an indexed component and assigns it to the axis of a new <see cref="Half3"/>. <para />
        /// For example, a swizzle input of (1,1) on a <see cref="Half3"/> with the values, 20 and 10, will return a vector with values 10,10, because it took the value of component index 1, for both axis."
        /// </summary>
        ...
        /// <returns></returns>
        public static unsafe Half3 Swizzle(Half3 val, int xIndex, int yIndex, int zIndex)
        {
            return new Half3()
            {
			   X = (&val.X)[xIndex],
        ...
        /// <returns></returns>
        public static unsafe Half3 Swizzle(Half3 val, uint xIndex, uint yIndex, uint zIndex)
        {
            return new Half3()
            {
			    X = (&val.X)[xIndex],
        ...
        /// <remarks>
        /// <see cref="Half3.DistanceSquared(Half3, Half3)"/> may be preferred when only the relative distance is needed
        /// and speed is of the essence.
        /// </remarks>
        public static short Distance(Half3 value1, Half3 value2)
        {
        ...
        public static short Dot(ref Half3 left, ref Half3 right)
        {
        ...
        /// Performs a Hermite spline interpolation.
        /// </summary>
        /// <param name="value1">First source position <see cref="Half3"/>.</param>
        /// <param name="tangent1">First source tangent <see cref="Half3"/>.</param>
        /// <param name="value2">Second source position <see cref="Half3"/>.</param>
        /// <param name="tangent2">Second source tangent <see cref="Half3"/>.</param>
        /// <param name="amount">Weighting factor.</param>
        /// <returns>The result of the Hermite spline interpolation.</returns>
        public static Half3 Hermite(Half3 value1, Half3 tangent1, Half3 value2, Half3 tangent2, short amount)
        {
        ...
        /// provides the same information and avoids calculating two square roots.
        /// </remarks>
		public static short DistanceSquared(Half3 value1, Half3 value2)
        {
            short x = value1.X - value2.X;
            short y = value1.Y - value2.Y;
            short z = value1.Z - value2.Z;
        ...
        /// <param name="amount">Weighting factor.</param>
        public static Half3 CatmullRom(ref Half3 value1, ref Half3 value2, ref Half3 value3, ref Half3 value4, short amount)
        {
            float squared = amount * amount;
            float cubed = amount * squared;
        ...
        public static Half3 CatmullRom(Half3 value1, Half3 value2, Half3 value3, Half3 value4, short amount)
        {
        ...
        public static Half3 Reflect(ref Half3 vector, ref Half3 normal)
        {
            short dot = (vector.X * normal.X) + (vector.Y * normal.Y) + (vector.Z * normal.Z);
        ...
        /// <summary>
        /// Converts the <see cref="Half3"/> into a unit vector.
        /// </summary>
        /// <param name="value">The <see cref="Half3"/> to normalize.</param>
        /// <returns>The normalized <see cref="Half3"/>.</returns>
