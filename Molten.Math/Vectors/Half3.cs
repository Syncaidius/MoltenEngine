...
#region Common Functions
        ...
        /// <param name="result">When the method completes, contains the dot product of the two <see cref="Half3"/> vectors.</param>
        ...
        public static Half3 Hermite(ref Half3 value1, ref Half3 tangent1, ref Half3 value2, ref Half3 tangent2, float amount)
        {
