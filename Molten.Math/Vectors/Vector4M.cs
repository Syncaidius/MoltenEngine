...
namespace Molten.Math
{
	...
	public partial struct Vector4M : IFormattable
	{
		...
		/// <summary>The X unit <see cref="Vector4M"/>.</summary>
		public static Vector4M UnitX = new Vector4M(1M, 0M, 0M, 0M);

		/// <summary>The Y unit <see cref="Vector4M"/>.</summary>
		public static Vector4M UnitY = new Vector4M(0M, 1M, 0M, 0M);

		/// <summary>The Z unit <see cref="Vector4M"/>.</summary>
		public static Vector4M UnitZ = new Vector4M(0M, 0M, 1M, 0M);

		/// <summary>The W unit <see cref="Vector4M"/>.</summary>
		public static Vector4M UnitW = new Vector4M(0M, 0M, 0M, 1M);

		/// <summary>Represents a zero'd Vector4M.</summary>
...
#region Constructors
		...
		/// <summary>
        /// Initializes a new instance of the <see cref="Vector4M"/> struct from an unsafe pointer. The pointer should point to an array of four elements.
        /// </summary>
...
#region Common Functions
        ...
        /// </remarks>
        public static Vector4M Lerp(ref Vector4M start, ref Vector4M end, decimal amount)
        {
			return new Vector4M()
			{
				...
				W = (decimal)((1M - amount) * start.W + amount * end.W),
			};
        }
		...
		/// <summary>
        /// Returns a <see cref="Vector4M"/> containing the 2D Cartesian coordinates of a point specified in Barycentric coordinates relative to a 2D triangle.
        /// </summary>
        /// <param name="value1">A <see cref="Vector4M"/> containing the 4D Cartesian coordinates of vertex 1 of the triangle.</param>
        /// <param name="value2">A <see cref="Vector4M"/> containing the 4D Cartesian coordinates of vertex 2 of the triangle.</param>
        /// <param name="value3">A <see cref="Vector4M"/> containing the 4D Cartesian coordinates of vertex 3 of the triangle.</param>
        /// <param name="amount1">Barycentric coordinate b2, which expresses the weighting factor toward vertex 2 (specified in <paramref name="value2"/>).</param>
        /// <param name="amount2">Barycentric coordinate b3, which expresses the weighting factor toward vertex 3 (specified in <paramref name="value3"/>).</param>
        public static Vector4M Barycentric(ref Vector4M value1, ref Vector4M value2, ref Vector4M value3, decimal amount1, decimal amount2)
        {
			return new Vector4M(
