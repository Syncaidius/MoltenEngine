...
#region Static Methods
        ...
        /// <param name="vec">The Vector4M to be truncated.</param>
        /// <returns></returns>
        public static Vector4M Truncate(Vector4M value)
        {
            return new Vector4M()
            {
				...
				W = (Math.Abs(value.W) - 0.0001M < 0) ? 0 : value.X,
            };
        }
#endregion
