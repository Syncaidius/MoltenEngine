...
#region Multiply operators
		...
		{
			return new SByte3(left * right.X, left * right.Y, left * right.Z);
		}
#endregion
...
#region Operators - Cast
        ///<summary>Casts a <see cref="SByte3"/> to a <see cref="Vector2"/>.</summary>
        public static explicit operator Vector2(SByte3 value)
        {
            return new Vector2(value.X, value.Y);
        }

        ///<summary>Casts a <see cref="SByte3"/> to a <see cref="Vector4"/>.</summary>
        public static explicit operator Vector4(SByte3 value)
        {
...
#region Static Methods
        ...
        public static SByte3 SmoothStep(ref SByte3 start, ref SByte3 end, sbyte amount)
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="source"/> or <paramref name="destination"/> is <c>null</c>.</exception>
        /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="destination"/> is shorter in length than <paramref name="source"/>.</exception>
        public static void Orthonormalize(SByte3[] destination, params SByte3[] source)
        {
            //Uses the modified Gram-Schmidt process.
        ...
        {
            sbyte dot = (vector.X * normal.X) + (vector.Y * normal.Y) + (vector.Z * normal.Z);
        ...
        /// <summary>
        /// Converts the <see cref="SByte3"/> into a unit vector.
        /// </summary>
        /// <param name="value">The <see cref="SByte3"/> to normalize.</param>
        /// <returns>The normalized <see cref="SByte3"/>.</returns>
        public static SByte3 Normalize(SByte3 value)
        {
            value.Normalize();
            return value;
        }
