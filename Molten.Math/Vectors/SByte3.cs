...
#region Common Functions
        ...
        /// <param name="result">When the method completes, contains the dot product of the two <see cref="SByte3"/> vectors.</param>
        ...
        public static SByte3 Hermite(ref SByte3 value1, ref SByte3 tangent1, ref SByte3 value2, ref SByte3 tangent2, float amount)
        {
