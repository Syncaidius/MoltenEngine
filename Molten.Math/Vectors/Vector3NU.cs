...
#region Static Methods
        ...
        public static bool NearEqual(Vector3NU left, Vector3NU right, Vector3NU epsilon)
        {
        ...
        /// <param name="epsilon">The epsilon.</param>
        /// <returns><c>true</c> if left and right are near another 3D, <c>false</c> otherwise</returns>
        public static bool NearEqual(ref Vector3NU left, ref Vector3NU right, ref Vector3NU epsilon)
        {
        ...
        public static Vector3NU SmoothStep(ref Vector3NU start, ref Vector3NU end, nuint amount)
        {
        ...
        public static Vector3NU SmoothStep(Vector3NU start, Vector3NU end, nuint amount)
        {
        ...
        /// <remarks>
        /// <see cref="Vector3NU.DistanceSquared(Vector3NU, Vector3NU)"/> may be preferred when only the relative distance is needed
        /// and speed is of the essence.
        /// </remarks>
        ...
        public static nuint Dot(ref Vector3NU left, ref Vector3NU right)
        {
        ...
        /// Performs a Hermite spline interpolation.
        /// </summary>
        /// <param name="value1">First source position <see cref="Vector3NU"/>.</param>
        /// <param name="tangent1">First source tangent <see cref="Vector3NU"/>.</param>
        /// <param name="value2">Second source position <see cref="Vector3NU"/>.</param>
        /// <param name="tangent2">Second source tangent <see cref="Vector3NU"/>.</param>
        /// <param name="amount">Weighting factor.</param>
        /// <returns>The result of the Hermite spline interpolation.</returns>
        public static Vector3NU Hermite(Vector3NU value1, Vector3NU tangent1, Vector3NU value2, Vector3NU tangent2, nuint amount)
        {
        ...
        /// provides the same information and avoids calculating two square roots.
        /// </remarks>
		public static nuint DistanceSquared(Vector3NU value1, Vector3NU value2)
        {
            nuint x = value1.X - value2.X;
            nuint y = value1.Y - value2.Y;
            nuint z = value1.Z - value2.Z;
        ...
        /// <param name="amount">Weighting factor.</param>
        public static Vector3NU CatmullRom(ref Vector3NU value1, ref Vector3NU value2, ref Vector3NU value3, ref Vector3NU value4, nuint amount)
        {
            float squared = amount * amount;
            float cubed = amount * squared;
        ...
        public static Vector3NU CatmullRom(Vector3NU value1, Vector3NU value2, Vector3NU value3, Vector3NU value4, nuint amount)
        {
        ...
        public static Vector3NU Reflect(ref Vector3NU vector, ref Vector3NU normal)
        {
            nuint dot = (vector.X * normal.X) + (vector.Y * normal.Y) + (vector.Z * normal.Z);
        ...
        /// <summary>
        /// Converts the <see cref="Vector3NU"/> into a unit vector.
        /// </summary>
        /// <param name="value">The <see cref="Vector3NU"/> to normalize.</param>
        /// <returns>The normalized <see cref="Vector3NU"/>.</returns>
        public static Vector3NU Normalize(Vector3NU value)
        {
            value.Normalize();
            return value;
        }
