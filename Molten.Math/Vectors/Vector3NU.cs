...
namespace Molten.Math
{
	...
	public partial struct Vector3NU : IFormattable
	{
        ...
        /// </summary>
		public static Vector3NU UnitX = new Vector3NU(1U, 0, 0);

		/// <summary>
        /// The Y unit <see cref="Vector3NU"/>.
        /// </summary>
		public static Vector3NU UnitY = new Vector3NU(0, 1U, 0);

		/// <summary>
        /// The Z unit <see cref="Vector3NU"/>.
        /// </summary>
		public static Vector3NU UnitZ = new Vector3NU(0, 0, 1U);

		public static Vector3NU Zero = new Vector3NU(0, 0, 0);
...
#region Common Functions
        ...
        /// <param name="result">When the method completes, contains the dot product of the two <see cref="Vector3NU"/> vectors.</param>
...
#region Static Methods
        ...
        /// <param name="vec">The Vector3NU to be truncated.</param>
        /// <returns></returns>
        public static Vector3NU Truncate(Vector3NU value)
        {
            return new Vector3NU()
            {
