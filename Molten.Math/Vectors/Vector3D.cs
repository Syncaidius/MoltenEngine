...
#region Common Functions
        ...
        /// <param name="result">When the method completes, contains the dot product of the two <see cref="Vector3D"/> vectors.</param>
        ...
        public static Vector3D Hermite(ref Vector3D value1, ref Vector3D tangent1, ref Vector3D value2, ref Vector3D tangent2, float amount)
        {
