...
#region Casts - vectors
        ...
        public static explicit operator SByte3(Vector3D val)
        {
            return new SByte3()
            {
                X = (sbyte)val.X,
        ...
        public static explicit operator Byte3(Vector3D val)
        {
            return new Byte3()
            {
                X = (byte)val.X,
        ...
        public static explicit operator Vector3I(Vector3D val)
        {
            return new Vector3I()
            {
                X = (int)val.X,
        ...
        public static explicit operator Vector3UI(Vector3D val)
        {
        ...
        public static explicit operator Vector3S(Vector3D val)
        {
            return new Vector3S()
            {
                X = (short)val.X,
        ...
        public static explicit operator Vector3US(Vector3D val)
        {
        ...
        public static explicit operator Vector3L(Vector3D val)
        {
            return new Vector3L()
            {
                X = (long)val.X,
        ...
        public static explicit operator Vector3UL(Vector3D val)
        {
        ...
        public static explicit operator Vector3F(Vector3D val)
        {
            return new Vector3F()
            {
                X = (float)val.X,
