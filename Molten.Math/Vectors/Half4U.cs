...
namespace Molten
{
	...
	public partial struct Half4U : IFormattable
	{
		...
		///<summary>A Half4U with every component set to (ushort)1.</summary>
		public static readonly Half4U One = new Half4U((ushort)1, (ushort)1, (ushort)1, (ushort)1);

		/// <summary>The X unit <see cref="Half4U"/>.</summary>
		public static readonly Half4U UnitX = new Half4U((ushort)1, 0, 0, 0);

		/// <summary>The Y unit <see cref="Half4U"/>.</summary>
		public static readonly Half4U UnitY = new Half4U(0, (ushort)1, 0, 0);

		/// <summary>The Z unit <see cref="Half4U"/>.</summary>
		public static readonly Half4U UnitZ = new Half4U(0, 0, (ushort)1, 0);

		/// <summary>The W unit <see cref="Half4U"/>.</summary>
		public static readonly Half4U UnitW = new Half4U(0, 0, 0, (ushort)1);

		/// <summary>Represents a zero'd Half4U.</summary>
		public static readonly Half4U Zero = new Half4U(0, 0, 0, 0);
...
#region Multiply operators
        ...
        public static Half4U operator *(ushort left, Half4U right)
		{
			return new Half4U(left * right.X, left * right.Y, left * right.Z, left * right.W);
		}
#endregion
...
#region Static Methods
        ...
        public static bool NearEqual(Half4U left, Half4U right, Half4U epsilon)
        {
        ...
        /// <param name="epsilon">The epsilon.</param>
        /// <returns><c>true</c> if left and right are near another 3D, <c>false</c> otherwise</returns>
        public static bool NearEqual(ref Half4U left, ref Half4U right, ref Half4U epsilon)
        {
        ...
        public static Half4U SmoothStep(ref Half4U start, ref Half4U end, ushort amount)
        {
        ...
        public static Half4U SmoothStep(Half4U start, Half4U end, ushort amount)
        {
            return SmoothStep(ref start, ref end, amount);
        }    

        /// <summary>
        /// Orthogonalizes a list of <see cref="Half4U"/>.
        /// </summary>
        /// <param name="destination">The list of orthogonalized <see cref="Half4U"/>.</param>
        ...
        public static void Orthogonalize(Half4U[] destination, params Half4U[] source)
        {
        ...
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="source"/> or <paramref name="destination"/> is <c>null</c>.</exception>
        /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="destination"/> is shorter in length than <paramref name="source"/>.</exception>
        public static void Orthonormalize(Half4U[] destination, params Half4U[] source)
        {
            //Uses the modified Gram-Schmidt process.
        ...
        /// <summary>
        /// Takes the value of an indexed component and assigns it to the axis of a new <see cref="Half4U"/>. <para />
        /// For example, a swizzle input of (1,1) on a <see cref="Half4U"/> with the values, 20 and 10, will return a vector with values 10,10, because it took the value of component index 1, for both axis."
        /// </summary>
        ...
        /// <returns></returns>
        public static unsafe Half4U Swizzle(Half4U val, int xIndex, int yIndex, int zIndex, int wIndex)
        {
            return new Half4U()
            {
			   X = (&val.X)[xIndex],
        ...
        /// <returns></returns>
        public static unsafe Half4U Swizzle(Half4U val, uint xIndex, uint yIndex, uint zIndex, uint wIndex)
        {
            return new Half4U()
            {
			    X = (&val.X)[xIndex],
        ...
        /// <remarks>
        /// <see cref="Half4U.DistanceSquared(Half4U, Half4U)"/> may be preferred when only the relative distance is needed
        /// and speed is of the essence.
        /// </remarks>
        public static ushort Distance(Half4U value1, Half4U value2)
        {
        ...
        public static Half4U Pow(Half4U vec, ushort power)
        {
            return new Half4U()
            {
        ...
        public static ushort Dot(ref Half4U left, ref Half4U right)
        {
        ...
        /// Performs a Hermite spline interpolation.
        /// </summary>
        /// <param name="value1">First source position <see cref="Half4U"/>.</param>
        /// <param name="tangent1">First source tangent <see cref="Half4U"/>.</param>
        /// <param name="value2">Second source position <see cref="Half4U"/>.</param>
        /// <param name="tangent2">Second source tangent <see cref="Half4U"/>.</param>
        /// <param name="amount">Weighting factor.</param>
        /// <returns>The result of the Hermite spline interpolation.</returns>
        public static Half4U Hermite(Half4U value1, Half4U tangent1, Half4U value2, Half4U tangent2, ushort amount)
        {
            return Hermite(ref value1, ref tangent1, ref value2, ref tangent2, amount);
        }

		/// <summary>
        /// Returns a <see cref="Half4U"/> containing the 2D Cartesian coordinates of a point specified in Barycentric coordinates relative to a 2D triangle.
        /// </summary>
        /// <param name="value1">A <see cref="Half4U"/> containing the 4D Cartesian coordinates of vertex 1 of the triangle.</param>
        /// <param name="value2">A <see cref="Half4U"/> containing the 4D Cartesian coordinates of vertex 2 of the triangle.</param>
        /// <param name="value3">A <see cref="Half4U"/> containing the 4D Cartesian coordinates of vertex 3 of the triangle.</param>
        /// <param name="amount1">Barycentric coordinate b2, which expresses the weighting factor toward vertex 2 (specified in <paramref name="value2"/>).</param>
        /// <param name="amount2">Barycentric coordinate b3, which expresses the weighting factor toward vertex 3 (specified in <paramref name="value3"/>).</param>
        public static Half4U Barycentric(ref Half4U value1, ref Half4U value2, ref Half4U value3, ushort amount1, ushort amount2)
        {
			return new Half4U(
        ...
        /// provides the same information and avoids calculating two square roots.
        /// </remarks>
		public static ushort DistanceSquared(Half4U value1, Half4U value2)
        {
            ushort x = value1.X - value2.X;
            ushort y = value1.Y - value2.Y;
            ushort z = value1.Z - value2.Z;
        ...
        /// <param name="amount">Weighting factor.</param>
        public static Half4U CatmullRom(ref Half4U value1, ref Half4U value2, ref Half4U value3, ref Half4U value4, ushort amount)
        {
            float squared = amount * amount;
            float cubed = amount * squared;
        ...
        public static Half4U CatmullRom(Half4U value1, Half4U value2, Half4U value3, Half4U value4, ushort amount)
        {
        ...
        public static Half4U Reflect(ref Half4U vector, ref Half4U normal)
        {
        ...
        /// <summary>
        /// Converts the <see cref="Half4U"/> into a unit vector.
        /// </summary>
        /// <param name="value">The <see cref="Half4U"/> to normalize.</param>
        /// <returns>The normalized <see cref="Half4U"/>.</returns>
        public static Half4U Normalize(Half4U value)
        {
            value.Normalize();
            return value;
        }
