...
#region Multiply operators
		...
		{
			return new Byte3(left * right.X, left * right.Y, left * right.Z);
		}
#endregion
...
#region Operators - Cast
        ///<summary>Casts a <see cref="Byte3"/> to a <see cref="Vector2"/>.</summary>
        public static explicit operator Vector2(Byte3 value)
        {
            return new Vector2(value.X, value.Y);
        }

        ///<summary>Casts a <see cref="Byte3"/> to a <see cref="Vector4"/>.</summary>
...
#region Static Methods
        ...
        /// <param name="amount">Weighting factor.</param>
        public static Byte3 CatmullRom(ref Byte3 value1, ref Byte3 value2, ref Byte3 value3, ref Byte3 value4, byte amount)
        {
            float squared = amount * amount;
            float cubed = amount * squared;
        ...
        public static Byte3 CatmullRom(Byte3 value1, Byte3 value2, Byte3 value3, Byte3 value4, byte amount)
        {
        ...
        {
            byte dot = (vector.X * normal.X) + (vector.Y * normal.Y) + (vector.Z * normal.Z);
