...
namespace Molten.Math
{
	...
	public partial struct Vector3M : IFormattable
	{
		...
		/// <summary>The X unit <see cref="Vector3M"/>.</summary>
		public static Vector3M UnitX = new Vector3M(1M, 0M, 0M);

		/// <summary>The Y unit <see cref="Vector3M"/>.</summary>
		public static Vector3M UnitY = new Vector3M(0M, 1M, 0M);

		/// <summary>The Z unit <see cref="Vector3M"/>.</summary>
		public static Vector3M UnitZ = new Vector3M(0M, 0M, 1M);

		/// <summary>Represents a zero'd Vector3M.</summary>
...
#region Constructors
		...
		/// <summary>
        /// Initializes a new instance of the <see cref="Vector3M"/> struct from an unsafe pointer. The pointer should point to an array of three elements.
        /// </summary>
...
#region Common Functions
        ...
        /// </remarks>
        public static Vector3M Lerp(ref Vector3M start, ref Vector3M end, decimal amount)
        {
			return new Vector3M()
			{
				X = (decimal)((1M - amount) * start.X + amount * end.X),
				Y = (decimal)((1M - amount) * start.Y + amount * end.Y),
				Z = (decimal)((1M - amount) * start.Z + amount * end.Z),
			};
        }
		...
		/// <summary>
        /// Calculates the dot product of two <see cref="Vector3M"/> vectors.
        /// </summary>
        /// <param name="left">First <see cref="Vector3M"/> source vector</param>
        /// <param name="right">Second <see cref="Vector3M"/> source vector.</param>
        /// <param name="result">When the method completes, contains the dot product of the two <see cref="Vector3M"/> vectors.</param>
        public static decimal Dot(Vector3M left, Vector3M right)
        {
        ...
        /// </summary>
        /// <param name="value1">First source position <see cref="Vector3M"/> vector.</param>
        /// <param name="tangent1">First source tangent <see cref="Vector3M"/> vector.</param>
        /// <param name="value2">Second source position <see cref="Vector3M"/> vector.</param>
        /// <param name="tangent2">Second source tangent <see cref="Vector3M"/> vector.</param>
        /// <param name="amount">Weighting factor.</param>
        public static Vector3M Hermite(ref Vector3M value1, ref Vector3M tangent1, ref Vector3M value2, ref Vector3M tangent2, decimal amount)
        {
		...
		/// <summary>
        /// Returns a <see cref="Vector3M"/> containing the 2D Cartesian coordinates of a point specified in Barycentric coordinates relative to a 2D triangle.
        /// </summary>
        /// <param name="value1">A <see cref="Vector3M"/> containing the 3D Cartesian coordinates of vertex 1 of the triangle.</param>
        /// <param name="value2">A <see cref="Vector3M"/> containing the 3D Cartesian coordinates of vertex 2 of the triangle.</param>
        /// <param name="value3">A <see cref="Vector3M"/> containing the 3D Cartesian coordinates of vertex 3 of the triangle.</param>
        /// <param name="amount1">Barycentric coordinate b2, which expresses the weighting factor toward vertex 2 (specified in <paramref name="value2"/>).</param>
        /// <param name="amount2">Barycentric coordinate b3, which expresses the weighting factor toward vertex 3 (specified in <paramref name="value3"/>).</param>
        public static Vector3M Barycentric(ref Vector3M value1, ref Vector3M value2, ref Vector3M value3, decimal amount1, decimal amount2)
        {
			return new Vector3M(
