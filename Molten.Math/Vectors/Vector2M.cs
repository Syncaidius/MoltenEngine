...
namespace Molten.Math
{
	...
	public partial struct Vector2M : IFormattable
	{
...
#region Common Functions
        ...
        /// </remarks>
        public static Vector2M Lerp(ref Vector2M start, ref Vector2M end, decimal amount)
        {
			return new Vector2M()
			{
		...
		/// <summary>
        /// Calculates the dot product of two <see cref="Vector2M"/> vectors.
        /// </summary>
        /// <param name="left">First <see cref="Vector2M"/> source vector</param>
        /// <param name="right">Second <see cref="Vector2M"/> source vector.</param>
        /// <param name="result">When the method completes, contains the dot product of the two <see cref="Vector2M"/> vectors.</param>
        public static decimal Dot(Vector2M left, Vector2M right)
        {
        ...
        /// </summary>
        /// <param name="value1">First source position <see cref="Vector2M"/> vector.</param>
        /// <param name="tangent1">First source tangent <see cref="Vector2M"/> vector.</param>
        /// <param name="value2">Second source position <see cref="Vector2M"/> vector.</param>
        /// <param name="tangent2">Second source tangent <see cref="Vector2M"/> vector.</param>
        /// <param name="amount">Weighting factor.</param>
        public static Vector2M Hermite(ref Vector2M value1, ref Vector2M tangent1, ref Vector2M value2, ref Vector2M tangent2, decimal amount)
        {
		...
		/// <summary>
        /// Returns a <see cref="Vector2M"/> containing the 2D Cartesian coordinates of a point specified in Barycentric coordinates relative to a 2D triangle.
        /// </summary>
        /// <param name="value1">A <see cref="Vector2M"/> containing the 2D Cartesian coordinates of vertex 1 of the triangle.</param>
        /// <param name="value2">A <see cref="Vector2M"/> containing the 2D Cartesian coordinates of vertex 2 of the triangle.</param>
        /// <param name="value3">A <see cref="Vector2M"/> containing the 2D Cartesian coordinates of vertex 3 of the triangle.</param>
        /// <param name="amount1">Barycentric coordinate b2, which expresses the weighting factor toward vertex 2 (specified in <paramref name="value2"/>).</param>
        /// <param name="amount2">Barycentric coordinate b3, which expresses the weighting factor toward vertex 3 (specified in <paramref name="value3"/>).</param>
        public static Vector2M Barycentric(ref Vector2M value1, ref Vector2M value2, ref Vector2M value3, decimal amount1, decimal amount2)
        {
			return new Vector2M(
