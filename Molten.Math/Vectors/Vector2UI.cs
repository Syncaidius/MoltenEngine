...
#region Static Methods
        ...
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="source"/> or <paramref name="destination"/> is <c>null</c>.</exception>
        /// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="destination"/> is shorter in length than <paramref name="source"/>.</exception>
        public static void Orthonormalize(Vector2UI[] destination, params Vector2UI[] source)
        {
            //Uses the modified Gram-Schmidt process.
        ...
        /// <param name="amount">Weighting factor.</param>
        public static Vector2UI CatmullRom(ref Vector2UI value1, ref Vector2UI value2, ref Vector2UI value3, ref Vector2UI value4, uint amount)
        {
            float squared = amount * amount;
            float cubed = amount * squared;
        ...
        public static Vector2UI CatmullRom(Vector2UI value1, Vector2UI value2, Vector2UI value3, Vector2UI value4, uint amount)
        {
        ...
        /// <summary>
        /// Converts the <see cref="Vector2UI"/> into a unit vector.
        /// </summary>
        /// <param name="value">The <see cref="Vector2UI"/> to normalize.</param>
        /// <returns>The normalized <see cref="Vector2UI"/>.</returns>
        public static Vector2UI Normalize(Vector2UI value)
        {
            value.Normalize();
            return value;
        }
