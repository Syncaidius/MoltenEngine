...
public partial struct RectangleF : IFormattable, IEquatable<RectangleF>
{
    ...
    /// <summary>Creates and returns an array containing the left, top, right and bottom values of the current <see cref="RectangleF"/>.</summary>
    /// <returns>An array containing the left, top, right and bottom values of the current <see cref="RectangleF"/>.</returns>
	...
	/// <value>The value of the <see cref="RectangleF"/> component, depending on the index.</value>
	...
	public unsafe float this[int index]
	{
		...
		{
			if(index < 0 || index > 3)
				throw new IndexOutOfRangeException("index for RectangleF must be between 0 and 3, inclusive.");
