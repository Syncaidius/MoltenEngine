...
namespace Molten
{
	...
	public partial struct RectangleF : IFormattable, IEquatable<RectangleF>
	{
		...
		/// <summary>Initializes a new instance of <see cref="RectangleF"/>.</summary>
		...
		/// <summary>Initializes a new instance of <see cref="RectangleF"/> from an array.</summary>
		...
		public unsafe RectangleF(float[] values)
		{
			...
			if (values.Length < 4)
				throw new ArgumentOutOfRangeException("values", "There must be at least 4 input values for RectangleF.");
		...
		/// <summary>Initializes a new instance of <see cref="RectangleF"/> from a span.</summary>
		/// <param name="values">The values to assign to the Left, Top, Right, Bottom components of the color. This must be an array with at least four elements.</param>
		/// <exception cref="ArgumentNullException">Thrown when <paramref name="values"/> is <c>null</c>.</exception>
		/// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="values"/> contains more or less than 4 elements.</exception>
		public RectangleF(Span<float> values)
		{
			if (values == null)
				throw new ArgumentNullException("values");
			if (values.Length < 4)
				throw new ArgumentOutOfRangeException("values", "There must be at least four input values for RectangleF.");
		...
		/// <summary>Initializes a new instance of <see cref="RectangleF"/> from a an unsafe pointer.</summary>
		...
		public unsafe RectangleF(float* ptrValues)
		{
			if (ptrValues == null)
