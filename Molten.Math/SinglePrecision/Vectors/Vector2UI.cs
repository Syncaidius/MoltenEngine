...
#region Constructors
		...
		public unsafe Vector2UI(uint* ptrValues)
		{
			...
			fixed (uint* dst = Values)
				Unsafe.CopyBlock(ptrValues, dst, (sizeof(uint) * 2));
		}
...
#region Indexers
		...
		/// <value>The value of the <see cref="Vector2UI"/> component, depending on the index.</value>
		...
		public unsafe uint this[int index]
		{
			...
			{
				if(index < 0 || index > 1)
					throw new IndexOutOfRangeException("index for Vector2UI must be between 0 and 1, inclusive.");
