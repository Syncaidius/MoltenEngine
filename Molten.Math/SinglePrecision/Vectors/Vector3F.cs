...
public partial struct Vector3F : IFormattable, ISignedVector<Vector3F, float>, IEquatable<Vector3F>
{
	...
	/// <summary>A fixed array mapped to the same memory space as the individual <see cref="Vector3F"/> components.</summary>
	[IgnoreDataMember]
	[FieldOffset(0)]
...
#region Constructors
	...
	public unsafe Vector3F(float[] values)
	{
		if (values == null)
			throw new ArgumentNullException("values");
		if (values.Length < 3)
			throw new ArgumentOutOfRangeException("values", "There must be at least 3 input values for Vector3F.");
	...
	///<summary>Creates a new instance of <see cref="Vector3F"/>, using a <see cref="Vector2F"/> to populate the first 2 components.</summary>
...
#region Tuples
    ...
    /// <summary>
    /// Constructs a <see cref="Vector3F"/> from 3 component values.
    /// </summary>
...
#region Indexers
	...
	/// <value>The value of the <see cref="Vector3F"/> component, depending on the index.</value>
	...
	public unsafe float this[int index]
	{
		...
		{
			if(index < 0 || index > 2)
				throw new IndexOutOfRangeException("index for Vector3F must be between 0 and 2, inclusive.");
