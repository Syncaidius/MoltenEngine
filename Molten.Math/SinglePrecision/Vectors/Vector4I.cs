...
[DataContract]
public partial struct Vector4I : IFormattable, ISignedVector<Vector4I, int>, IEquatable<Vector4I>
{
	...
	/// <summary>A fixed array mapped to the same memory space as the individual <see cref="Vector4I"/> components.</summary>
	[IgnoreDataMember]
	[FieldOffset(0)]
...
#region Constructors
	...
	public unsafe Vector4I(int[] values)
	{
		if (values == null)
			throw new ArgumentNullException("values");
		if (values.Length < 4)
			throw new ArgumentOutOfRangeException("values", "There must be at least 4 input values for Vector4I.");

		fixed (int* src = values)
		{
			fixed (int* dst = Values)
				Unsafe.CopyBlock(src, dst, (sizeof(int) * 4));
		}
	}
	...
	public unsafe Vector4I(int* ptrValues)
	{
		...
		fixed (int* dst = Values)
			Unsafe.CopyBlock(ptrValues, dst, (sizeof(int) * 4));
	}

	///<summary>Creates a new instance of <see cref="Vector4I"/>, using a <see cref="Vector2I"/> to populate the first 2 components.</summary>
	...
	///<summary>Creates a new instance of <see cref="Vector4I"/>, using a <see cref="Vector3I"/> to populate the first 3 components.</summary>
...
#region Tuples
    ...
    /// <summary>
    /// Constructs a <see cref="Vector4I"/> from 4 component values.
    /// </summary>
    ...
    {
        return new Vector4I(tuple.x, tuple.y, tuple.z, tuple.w);
    }
#endregion
...
#region To-String
	/// <summary>
    /// Returns a <see cref="string"/> that represents this <see cref="Vector4I"/>.
    /// </summary>
    /// <param name="format">The format.</param>
    /// <returns>
    /// A <see cref="string"/> that represents this <see cref="Vector4I"/>.
    /// </returns>
...
#region Add operators
	...
	///<summary>Performs a add operation on a <see cref="Vector4I"/> and a <see cref="int"/>.</summary>
	///<param name="a">The <see cref="Vector4I"/> to add.</param>
	///<param name="b">The <see cref="int"/> to add.</param>
	///<param name="result">Output for the result of the operation.</param>
	public static void Add(ref Vector4I a, int b, out Vector4I result)
	{
		result.X = a.X + b;
		result.Y = a.Y + b;
		result.Z = a.Z + b;
	...
	{
		Add(ref a, b, out Vector4I result);
		return result;
	}

	///<summary>Performs a add operation on a <see cref="int"/> and a <see cref="Vector4I"/>.</summary>
	///<param name="a">The <see cref="int"/> to add.</param>
	///<param name="b">The <see cref="Vector4I"/> to add.</param>
	///<returns>The result of the operation.</returns>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Vector4I operator +(int a, Vector4I b)
	{
		Add(ref b, a, out Vector4I result);
		return result;
	}
...
#region Subtract operators
	...
	///<summary>Performs a subtract operation on a <see cref="Vector4I"/> and a <see cref="int"/>.</summary>
	///<param name="a">The <see cref="Vector4I"/> to subtract.</param>
	///<param name="b">The <see cref="int"/> to subtract.</param>
	///<param name="result">Output for the result of the operation.</param>
	public static void Subtract(ref Vector4I a, int b, out Vector4I result)
	{
		result.X = a.X - b;
		result.Y = a.Y - b;
		result.Z = a.Z - b;
	...
	public static Vector4I operator -(Vector4I a, int b)
	{
		Subtract(ref a, b, out Vector4I result);
		return result;
	}

	///<summary>Performs a subtract operation on a <see cref="int"/> and a <see cref="Vector4I"/>.</summary>
	///<param name="a">The <see cref="int"/> to subtract.</param>
	///<param name="b">The <see cref="Vector4I"/> to subtract.</param>
	///<returns>The result of the operation.</returns>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Vector4I operator -(int a, Vector4I b)
	{
		Subtract(ref b, a, out Vector4I result);
		return result;
	}
...
#region division operators
	...
	///<summary>Performs a divide operation on a <see cref="Vector4I"/> and a <see cref="int"/>.</summary>
	///<param name="a">The <see cref="Vector4I"/> to divide.</param>
	///<param name="b">The <see cref="int"/> to divide.</param>
	///<param name="result">Output for the result of the operation.</param>
	public static void Divide(ref Vector4I a, int b, out Vector4I result)
	{
		result.X = a.X / b;
		result.Y = a.Y / b;
		result.Z = a.Z / b;
	...
	public static Vector4I operator /(Vector4I a, int b)
	{
		Divide(ref a, b, out Vector4I result);
		return result;
	}

	///<summary>Performs a divide operation on a <see cref="int"/> and a <see cref="Vector4I"/>.</summary>
	///<param name="a">The <see cref="int"/> to divide.</param>
	///<param name="b">The <see cref="Vector4I"/> to divide.</param>
	///<returns>The result of the operation.</returns>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Vector4I operator /(int a, Vector4I b)
	{
		Divide(ref b, a, out Vector4I result);
		return result;
	}
...
#region Multiply operators
	...
	///<summary>Performs a multiply operation on a <see cref="Vector4I"/> and a <see cref="int"/>.</summary>
	///<param name="a">The <see cref="Vector4I"/> to multiply.</param>
	///<param name="b">The <see cref="int"/> to multiply.</param>
	///<param name="result">Output for the result of the operation.</param>
	public static void Multiply(ref Vector4I a, int b, out Vector4I result)
	{
		result.X = a.X * b;
		result.Y = a.Y * b;
		result.Z = a.Z * b;
	...
	public static Vector4I operator *(Vector4I a, int b)
	{
		Multiply(ref a, b, out Vector4I result);
		return result;
	}

	///<summary>Performs a multiply operation on a <see cref="int"/> and a <see cref="Vector4I"/>.</summary>
	///<param name="a">The <see cref="int"/> to multiply.</param>
	///<param name="b">The <see cref="Vector4I"/> to multiply.</param>
	///<returns>The result of the operation.</returns>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Vector4I operator *(int a, Vector4I b)
	{
		Multiply(ref b, a, out Vector4I result);
		return result;
	}
...
#region Static Methods
    ...
    public static Vector4I Reflect(Vector4I vector, Vector4I normal)
    {
...
#region Indexers
	...
	/// <value>The value of the <see cref="Vector4I"/> component, depending on the index.</value>
	...
	public unsafe int this[int index]
	{
		...
		{
			if(index < 0 || index > 3)
				throw new IndexOutOfRangeException("index for Vector4I must be between 0 and 3, inclusive.");
