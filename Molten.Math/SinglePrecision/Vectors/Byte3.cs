...
#region Constructors
	...
	public unsafe Byte3(byte* ptrValues)
	{
		...
		fixed (byte* dst = Values)
			Unsafe.CopyBlock(ptrValues, dst, (sizeof(byte) * 3));
	}
...
#region Indexers
	...
	/// <value>The value of the <see cref="Byte3"/> component, depending on the index.</value>
	...
	public unsafe byte this[int index]
	{
		...
		{
			if(index < 0 || index > 2)
				throw new IndexOutOfRangeException("index for Byte3 must be between 0 and 2, inclusive.");
