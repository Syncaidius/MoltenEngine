...
namespace Molten
{
    ...
    [Serializable]
	public partial struct Vector3UI : IFormattable, IVector<uint>, IEquatable<Vector3UI>
	{
...
#region Constructors
		...
		public Vector3UI(uint[] values)
		{
			...
			if (values.Length < 3)
				throw new ArgumentOutOfRangeException("values", "There must be at least three input values for Vector3UI.");
