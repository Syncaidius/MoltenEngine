...
#region Constructors
	...
	public unsafe Vector4UI(uint* ptrValues)
	{
		...
		fixed (uint* dst = Values)
			Unsafe.CopyBlock(ptrValues, dst, (sizeof(uint) * 4));
	}
...
#region To-String
	/// <summary>
    /// Returns a <see cref="string"/> that represents this <see cref="Vector4UI"/>.
    /// </summary>
    /// <param name="format">The format.</param>
    /// <returns>
    /// A <see cref="string"/> that represents this <see cref="Vector4UI"/>.
    /// </returns>
...
#region Indexers
	...
	/// <value>The value of the <see cref="Vector4UI"/> component, depending on the index.</value>
	...
	public unsafe uint this[int index]
	{
		...
		{
			if(index < 0 || index > 3)
				throw new IndexOutOfRangeException("index for Vector4UI must be between 0 and 3, inclusive.");
...
#region Casts - vectors
	///<summary>Casts a <see cref="Vector4UI"/> to a <see cref="SByte2"/>.</summary>
	public static explicit operator SByte2(Vector4UI value)
	{
		return new SByte2((sbyte)value.X, (sbyte)value.Y);
	}

	///<summary>Casts a <see cref="Vector4UI"/> to a <see cref="SByte3"/>.</summary>
	...
	///<summary>Casts a <see cref="Vector4UI"/> to a <see cref="Byte2"/>.</summary>
	public static explicit operator Byte2(Vector4UI value)
	{
		return new Byte2((byte)value.X, (byte)value.Y);
	}

	///<summary>Casts a <see cref="Vector4UI"/> to a <see cref="Byte3"/>.</summary>
	...
	///<summary>Casts a <see cref="Vector4UI"/> to a <see cref="Vector2I"/>.</summary>
	public static explicit operator Vector2I(Vector4UI value)
	{
		return new Vector2I((int)value.X, (int)value.Y);
	}

	///<summary>Casts a <see cref="Vector4UI"/> to a <see cref="Vector3I"/>.</summary>
	...
	///<summary>Casts a <see cref="Vector4UI"/> to a <see cref="Vector2S"/>.</summary>
	public static explicit operator Vector2S(Vector4UI value)
	{
		return new Vector2S((short)value.X, (short)value.Y);
	}

	///<summary>Casts a <see cref="Vector4UI"/> to a <see cref="Vector3S"/>.</summary>
	...
	///<summary>Casts a <see cref="Vector4UI"/> to a <see cref="Vector2US"/>.</summary>
	public static explicit operator Vector2US(Vector4UI value)
	{
		return new Vector2US((ushort)value.X, (ushort)value.Y);
	}

	///<summary>Casts a <see cref="Vector4UI"/> to a <see cref="Vector3US"/>.</summary>
	...
	///<summary>Casts a <see cref="Vector4UI"/> to a <see cref="Vector2L"/>.</summary>
	public static explicit operator Vector2L(Vector4UI value)
	{
		return new Vector2L((long)value.X, (long)value.Y);
	}

	///<summary>Casts a <see cref="Vector4UI"/> to a <see cref="Vector3L"/>.</summary>
	...
	///<summary>Casts a <see cref="Vector4UI"/> to a <see cref="Vector2UL"/>.</summary>
	public static explicit operator Vector2UL(Vector4UI value)
	{
		return new Vector2UL((ulong)value.X, (ulong)value.Y);
	}

	///<summary>Casts a <see cref="Vector4UI"/> to a <see cref="Vector3UL"/>.</summary>
	...
	///<summary>Casts a <see cref="Vector4UI"/> to a <see cref="Vector2F"/>.</summary>
	public static explicit operator Vector2F(Vector4UI value)
	{
		return new Vector2F((float)value.X, (float)value.Y);
	}

	///<summary>Casts a <see cref="Vector4UI"/> to a <see cref="Vector3F"/>.</summary>
	...
	///<summary>Casts a <see cref="Vector4UI"/> to a <see cref="Vector2D"/>.</summary>
	public static explicit operator Vector2D(Vector4UI value)
	{
		return new Vector2D((double)value.X, (double)value.Y);
	}

	///<summary>Casts a <see cref="Vector4UI"/> to a <see cref="Vector3D"/>.</summary>
