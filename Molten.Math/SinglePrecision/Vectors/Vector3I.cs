...
[DataContract]
public partial struct Vector3I : IFormattable, ISignedVector<Vector3I, int>, IEquatable<Vector3I>
{
	...
	/// <summary>A fixed array mapped to the same memory space as the individual <see cref="Vector3I"/> components.</summary>
	[IgnoreDataMember]
	[FieldOffset(0)]
	public unsafe fixed int Values[3];
...
#region Constructors
	...
	public unsafe Vector3I(int[] values)
	{
		if (values == null)
			throw new ArgumentNullException("values");
		if (values.Length < 3)
			throw new ArgumentOutOfRangeException("values", "There must be at least 3 input values for Vector3I.");

		fixed (int* src = values)
		{
			fixed (int* dst = Values)
				Unsafe.CopyBlock(src, dst, (sizeof(int) * 3));
		}
	}
	...
	public unsafe Vector3I(int* ptrValues)
	{
		...
		fixed (int* dst = Values)
			Unsafe.CopyBlock(ptrValues, dst, (sizeof(int) * 3));
	}

	///<summary>Creates a new instance of <see cref="Vector3I"/>, using a <see cref="Vector2I"/> to populate the first 2 components.</summary>
...
#region Tuples
    ...
    /// <summary>
    /// Constructs a <see cref="Vector3I"/> from 3 component values.
    /// </summary>
    ...
    {
        return new Vector3I(tuple.x, tuple.y, tuple.z);
    }
#endregion
...
#region Indexers
	...
	/// <value>The value of the <see cref="Vector3I"/> component, depending on the index.</value>
	...
	public unsafe int this[int index]
	{
		...
		{
			if(index < 0 || index > 2)
				throw new IndexOutOfRangeException("index for Vector3I must be between 0 and 2, inclusive.");
