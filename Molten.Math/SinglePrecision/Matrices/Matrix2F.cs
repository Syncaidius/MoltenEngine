...
namespace Molten
{
	...
	public partial struct Matrix2F : IEquatable<Matrix2F>, IFormattable, ITransposableMatrix<Matrix2F, Matrix2F>, IUniformMatrix<float>
    {
		...
		/// <value>The value of the <see cref="Matrix2F"/> component, depending on the index.</value>
		...
		public unsafe float this[int index]
		{
			...
			{
				if(index < 0 || index > 3)
					throw new IndexOutOfRangeException("index for Matrix2F must be between 0 and 3, inclusive.");
		...
		public unsafe float this[int row, int column]
		{
			...
			{
				if(row < 0 || row > 3)
					throw new IndexOutOfRangeException("row for Matrix2F must be between 0 and 3, inclusive.");

				if(column < 0 || column > 3)
					throw new IndexOutOfRangeException("column for Matrix2F must be between 0 and 3, inclusive.");
