...
namespace Molten
{
	...
	public partial struct Matrix2x3F : IEquatable<Matrix2x3F>, IFormattable, ITransposableMatrix<Matrix2x3F, Matrix3x2F>, IMatrix<float>
    {
        ...
        public void TransposeTo(out Matrix3x2F result)
        {
            TransposeTo(ref this, out result);
        }
      
        /// <summary>
        /// Transposes the current <see cref="Matrix2x3F"/> in-place, to a <see cref="Matrix3x2F"/>.
        /// </summary>
        public Matrix3x2F TransposeTo()
        {
            TransposeTo(ref this, out Matrix3x2F result);
            return result;
        }
        ...
        public static void TransposeTo(ref Matrix2x3F matrix, out Matrix3x2F result)
        {
        ...
        public static Matrix3x2F TransposeTo(Matrix2x3F value)
        {
            TransposeTo(ref value, out Matrix3x2F result);
            return result;
        }
		...
		/// <value>The value of the <see cref="Matrix2x3F"/> component, depending on the index.</value>
		...
		public unsafe float this[int index]
		{
			...
			{
				if(index < 0 || index > 5)
					throw new IndexOutOfRangeException("index for Matrix2x3F must be between 0 and 5, inclusive.");
		...
		public unsafe float this[int row, int column]
		{
			...
			{
				if(row < 0 || row > 5)
					throw new IndexOutOfRangeException("row for Matrix2x3F must be between 0 and 5, inclusive.");

				if(column < 0 || column > 5)
					throw new IndexOutOfRangeException("column for Matrix2x3F must be between 0 and 5, inclusive.");
