...
public partial struct Matrix4F : IEquatable<Matrix4F>, IFormattable, ITransposableMatrix<Matrix4F, Matrix4F>, IUniformMatrix<float>
{
	...
	/// <value>The value of the <see cref="Matrix4F"/> component, depending on the index.</value>
	...
	public unsafe float this[int index]
	{
		...
		{
			if(index < 0 || index > 15)
				throw new IndexOutOfRangeException("index for Matrix4F must be between 0 and 15, inclusive.");
	...
	public unsafe float this[int row, int column]
	{
		...
		{
			if(row < 0 || row > 15)
				throw new IndexOutOfRangeException("row for Matrix4F must be between 0 and 15, inclusive.");

			if(column < 0 || column > 15)
				throw new IndexOutOfRangeException("column for Matrix4F must be between 0 and 15, inclusive.");
