...
namespace Molten
{
	...
	public partial struct Matrix3x2F : IEquatable<Matrix3x2F>, IFormattable, ITransposableMatrix<Matrix3x2F, Matrix2x3F>, IMatrix<float>
    {
		...
		/// <value>The value of the <see cref="Matrix3x2F"/> component, depending on the index.</value>
		...
		public unsafe float this[int index]
		{
			...
			{
				if(index < 0 || index > 5)
					throw new IndexOutOfRangeException("index for Matrix3x2F must be between 0 and 5, inclusive.");
		...
		public unsafe float this[int row, int column]
		{
			...
			{
				if(row < 0 || row > 5)
					throw new IndexOutOfRangeException("row for Matrix3x2F must be between 0 and 5, inclusive.");

				if(column < 0 || column > 5)
					throw new IndexOutOfRangeException("column for Matrix3x2F must be between 0 and 5, inclusive.");
