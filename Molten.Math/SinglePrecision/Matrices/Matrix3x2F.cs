...
namespace Molten
{
    /// <summary>Represents a single-precision 3x2 Matrix. Contains only scale and rotation.</summary>
    [StructLayout(LayoutKind.Explicit)]
    [DataContract]
	public partial struct Matrix3x2F : IEquatable<Matrix3x2F>, IFormattable, ITransposableMatrix<Matrix3x2F, Matrix2x3F>, IMatrix<float>
    {
        /// <summary>
        /// A single-precision <see cref="Matrix3x2F"/> with values intialized to the identity of a 2 x 2 matrix
        /// </summary>
        public static readonly Matrix3x2F Identity = new Matrix3x2F() 
        { 
            M11 = 1F, 
            M22 = 1F, 
        };
        ...
        /// <summary>A <see cref="Matrix3x2F"/> will all of its components set to 0F.</summary>
		...
		/// <summary>A fixed array mapped to the same memory space as the individual <see cref="Matrix3x2F"/> components.</summary>
		[IgnoreDataMember]
		[FieldOffset(0)]
		public unsafe fixed float Values[6];


        /// <summary> Row 1 of the current <see cref="Matrix3x2F"/>.</summary>
        ...
        /// <summary> Row 2 of the current <see cref="Matrix3x2F"/>.</summary>
        /// <returns>A <see cref="Vector3F"/> containing the row values.</returns>
        ...
        /// <summary> Row 3 of the current <see cref="Matrix3x2F"/>.</summary>
        /// <returns>A <see cref="Vector3F"/> containing the row values.</returns>
        ...
        /// <summary> Column 1 of the current <see cref="Matrix3x2F"/>.</summary>
        ...
        /// <summary> Column 2 of the current <see cref="Matrix3x2F"/>.</summary>
        /// <returns>A <see cref="Vector3F"/> containing the column values.</returns>
		...
		/// <summary>
		/// Initializes a new instance of <see cref="Matrix3x2F"/>.
		/// </summary>
		...
		/// <summary>Initializes a new instance of <see cref="Matrix3x2F"/>.</summary>
		...
		/// <summary>Initializes a new instance of <see cref="Matrix3x2F"/> from an array.</summary>
		...
		public unsafe Matrix3x2F(float[] values)
		{
			if (values == null)
				throw new ArgumentNullException("values");
			if (values.Length < 6)
				throw new ArgumentOutOfRangeException("values", "There must be at least 6 input values for Matrix3x2F.");
		...
		/// <summary>Initializes a new instance of <see cref="Matrix3x2F"/> from a span.</summary>
		/// <param name="values">The values to assign to the M11, M12, M21, M22, M31, M32 components of the color. This must be an array with at least 6 elements.</param>
		/// <exception cref="ArgumentNullException">Thrown when <paramref name="values"/> is <c>null</c>.</exception>
		/// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="values"/> contains more or less than 6 elements.</exception>
		public Matrix3x2F(Span<float> values)
		{
			if (values == null)
				throw new ArgumentNullException("values");
			if (values.Length < 6)
		...
		/// <summary>Initializes a new instance of <see cref="Matrix3x2F"/> from a an unsafe pointer.</summary>
		...
		public unsafe Matrix3x2F(float* ptrValues)
		{
			if (ptrValues == null)
        ...
        /// <summary>
        /// Creates an array containing the elements of the <see cref="Matrix3x2F"/>.
        /// </summary>
        ...
        /// <summary>
        /// Calculates the transposed <see cref="Matrix2x3F"/> of the specified <see cref="Matrix3x2F"/>.
        /// </summary>
        ...
        /// <summary>
        /// Calculates the transpose of the specified <see cref="Matrix3x2F"/>.
        /// </summary>
        ...
        /// <summary>
        /// Performs a linear interpolation between two <see cref="Matrix3x2F"/>.
        /// </summary>
        /// <param name="start">Start <see cref="Matrix3x2F"/>.</param>
        /// <param name="end">End <see cref="Matrix3x2F"/>.</param>
        /// <param name="amount">Value between 0 and 1 indicating the weight of <paramref name="end"/>.</param>
        /// <param name="result">When the method completes, contains the linear interpolation of the two <see cref="Matrix3x2F"/> matrices.</param>
        /// <remarks>
        ...
        /// <summary>
        /// Performs a cubic interpolation between two <see cref="Matrix3x2F"/>.
        /// </summary>
        /// <param name="start">Start <see cref="Matrix3x2F"/>.</param>
        /// <param name="end">End <see cref="Matrix3x2F"/>.</param>
        /// <param name="amount">Value between 0F and 1F indicating the weight of <paramref name="end"/>.</param>
        /// <param name="result">When the method completes, contains the cubic interpolation of the two <see cref="Matrix3x2F"/> matrices.</param>
        ...
        {
            SmoothStep(ref start, ref end, amount, out Matrix3x2F result);
            return result;
        }
        ...
        {
            Lerp(ref start, ref end, amount, out Matrix3x2F result);
            return result;
        }
		...
		public unsafe float this[int index]
		{
            ...
            {
                if(index > 5 || index < 0)
                    throw new IndexOutOfRangeException("Index for Matrix3x2F must be between from 0 to 5, inclusive.");
		...
		public unsafe float this[uint index]
		{
            ...
            {
                if(index > 5)
                    throw new IndexOutOfRangeException("Index for Matrix3x2F must less than 6.");
        ...
        /// <returns>The value of the component at the specified index.</returns>
        /// <exception cref="System.ArgumentOutOfRangeException">Thrown when the <paramref name="row"/> [0 to 2] or <paramref name="column"/> [0 to 1] is out of the range .</exception>
        public unsafe float this[int row, int column]
        {
            get
            {
                if (row < 0 || row > 2)
                    throw new ArgumentOutOfRangeException("row", "Rolumns for Matrix3x2F run from 0 to 2, inclusive.");
        ...
        /// <summary>
        /// Returns a hash code for the current <see cref="Matrix3x2F"/>.
        /// </summary>
        /// <returns>
        /// A hash code for the current <see cref="Matrix3x2F"/>, suitable for use in hashing algorithms and data structures like a hash table. 
        /// </returns>
        ...
        public static bool operator ==(Matrix3x2F matrix1, Matrix3x2F matrix2)
        {
...
#region Add operators
		///<summary>Performs a add operation on two <see cref="Matrix3x2F"/>.</summary>
		///<param name="a">The first <see cref="Matrix3x2F"/> to add.</param>
		///<param name="b">The second <see cref="Matrix3x2F"/> to add.</param>
		///<param name="result">Output for the result of the operation.</param>
		public static void Add(ref Matrix3x2F a, ref Matrix3x2F b, out Matrix3x2F result)
		{
		...
		{
			Add(ref a, ref b, out Matrix3x2F result);
			return result;
		}

		///<summary>Performs a add operation on a <see cref="Matrix3x2F"/> and a <see cref="float"/>.</summary>
		///<param name="a">The <see cref="Matrix3x2F"/> to add.</param>
		///<param name="b">The <see cref="float"/> to add.</param>
		///<param name="result">Output for the result of the operation.</param>
		public static void Add(ref Matrix3x2F a, float b, out Matrix3x2F result)
		{
			result.M11 = a.M11 + b;
			result.M12 = a.M12 + b;
			result.M21 = a.M21 + b;
		...
		///<returns>The result of the operation.</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Matrix3x2F operator +(Matrix3x2F a, float b)
		{
			Add(ref a, b, out Matrix3x2F result);
			return result;
		}

		///<summary>Performs a add operation on a <see cref="float"/> and a <see cref="Matrix3x2F"/>.</summary>
		///<param name="a">The <see cref="float"/> to add.</param>
		///<param name="b">The <see cref="Matrix3x2F"/> to add.</param>
		///<returns>The result of the operation.</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Matrix3x2F operator +(float a, Matrix3x2F b)
		{
			Add(ref b, a, out Matrix3x2F result);
			return result;
		}


        /// <summary>
        /// Assert a <see cref="Matrix3x2F"/> (return it unchanged).
        /// </summary>
        /// <param name="value">The <see cref="Matrix3x2F"/> to assert (unchanged).</param>
        /// <returns>The asserted (unchanged) <see cref="Matrix3x2F"/>.</returns>
...
#region Subtract operators
		///<summary>Performs a subtract operation on two <see cref="Matrix3x2F"/>.</summary>
		///<param name="a">The first <see cref="Matrix3x2F"/> to subtract.</param>
		///<param name="b">The second <see cref="Matrix3x2F"/> to subtract.</param>
		///<param name="result">Output for the result of the operation.</param>
		public static void Subtract(ref Matrix3x2F a, ref Matrix3x2F b, out Matrix3x2F result)
		{
			result.M11 = a.M11 - b.M11;
			result.M12 = a.M12 - b.M12;
			result.M21 = a.M21 - b.M21;
		...
		public static Matrix3x2F operator -(Matrix3x2F a, Matrix3x2F b)
		{
			Subtract(ref a, ref b, out Matrix3x2F result);
			return result;
		}

		///<summary>Performs a subtract operation on a <see cref="Matrix3x2F"/> and a <see cref="float"/>.</summary>
		///<param name="a">The <see cref="Matrix3x2F"/> to subtract.</param>
		///<param name="b">The <see cref="float"/> to subtract.</param>
		///<param name="result">Output for the result of the operation.</param>
		public static void Subtract(ref Matrix3x2F a, float b, out Matrix3x2F result)
		{
			result.M11 = a.M11 - b;
			result.M12 = a.M12 - b;
			result.M21 = a.M21 - b;
		...
		public static Matrix3x2F operator -(Matrix3x2F a, float b)
		{
			Subtract(ref a, b, out Matrix3x2F result);
			return result;
		}

		///<summary>Performs a subtract operation on a <see cref="float"/> and a <see cref="Matrix3x2F"/>.</summary>
		///<param name="a">The <see cref="float"/> to subtract.</param>
		///<param name="b">The <see cref="Matrix3x2F"/> to subtract.</param>
		///<returns>The result of the operation.</returns>
		[MethodImpl(MethodImplOptions.AggressiveInlining)]
		public static Matrix3x2F operator -(float a, Matrix3x2F b)
		{
			Subtract(ref b, a, out Matrix3x2F result);
			return result;
		}


        /// <summary>
        /// Negates a <see cref="Matrix3x2F"/>.
        /// </summary>
        /// <param name="value">The matrix to be negated.</param>
        /// <param name="result">When the method completes, contains the negated <see cref="Matrix3x2F"/>.</param>
        ...
        /// Negates a <see cref="Matrix3x2F"/>.
        /// </summary>
        /// <param name="value">The <see cref="Matrix3x2F"/> to be negated.</param>
        ...
        /// Negates a <see cref="Matrix3x2F"/>.
        /// </summary>
        /// <param name="value">The <see cref="Matrix3x2F"/> to negate.</param>
        /// <returns>The negated <see cref="Matrix3x2F"/>.</returns>
        public static Matrix3x2F operator -(Matrix3x2F value)
        {
...
#region Multiply operators
        /// <summary>
        /// Scales a <see cref="Matrix3x2F"/> by the given scalar value.
        /// </summary>
        /// <param name="matrix">The <see cref="Matrix3x2F"/> to scale.</param>
        /// <param name="scalar">The scalar value by which to scale.</param>
        /// <param name="result">When the method completes, contains the scaled <see cref="Matrix3x2F"/>.</param>
        public static void Multiply(ref Matrix3x2F matrix, float scalar, out Matrix3x2F result)
        {
        ...
        /// <summary>
        /// Scales a <see cref="Matrix3x2F"/> by a given value.
        /// </summary>
        /// <param name="matrix">The <see cref="Matrix3x2F"/> to scale.</param>
        /// <param name="scalar">The scalar value by which to scale.</param>
        ...
        {
            Multiply(ref matrix, scalar, out Matrix3x2F result);
            return result;
        }
...
/// <summary>
        ...
        /// <param name="result">When the method completes, contains the scaled <see cref="Matrix3x2F"/>.</param>
        public static void Divide(ref Matrix3x2F matrix, float scalar, out Matrix3x2F result)
        {
            float inv = 1F / scalar;
        ...
        {
            Divide(ref matrix, scalar, out Matrix3x2F result);
            return result;
        }
        ...
        /// </summary>
        /// <param name="left">The first <see cref="Matrix3x2F"/> to divide.</param>
        /// <param name="right">The second <see cref="Matrix3x2F"/> to divide.</param>
        /// <param name="result">When the method completes, contains the quotient of the two <see cref="Matrix3x2F"/> matrices.</param>
        ...
        /// <summary>
        /// Scales a <see cref="Matrix3x2F"/> by a given scalar value.
        /// </summary>
        ...
        /// <summary>
        /// Divides two <see cref="Matrix3x2F"/> matrices.
        /// </summary>
        /// <param name="left">The first <see cref="Matrix3x2F"/> to divide.</param>
        /// <param name="right">The second <see cref="Matrix3x2F"/> to divide.</param>
        /// <returns>The quotient of the two <see cref="Matrix3x2F"/> matrices.</returns>
        public static Matrix3x2F operator /(Matrix3x2F left, Matrix3x2F right)
        {
            Divide(ref left, ref right, out Matrix3x2F result);
            return result;
        }
#endregion
    }
