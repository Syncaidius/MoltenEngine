...
namespace Molten.DoublePrecision
{
	...
	public partial struct RectangleL : IFormattable, IEquatable<RectangleL>
	{
		...
		/// <summary>
		/// Initializes a new instance of <see cref="RectangleL"/>.
		/// </summary>
		...
		/// <summary>Initializes a new instance of <see cref="RectangleL"/>.</summary>
		/// <param name="value">The value that will be assigned to all components.</param>
		public RectangleL(long value)
		{
			Left = value;
			Top = value;
			Right = value;
		...
		/// <summary>Initializes a new instance of <see cref="RectangleL"/> from an array.</summary>
		...
		public unsafe RectangleL(long[] values)
		{
			...
			if (values.Length < 4)
				throw new ArgumentOutOfRangeException("values", "There must be at least 4 input values for RectangleL.");
		...
		/// <summary>Initializes a new instance of <see cref="RectangleL"/> from a span.</summary>
		/// <param name="values">The values to assign to the Left, Top, Right, Bottom components of the color. This must be an array with at least four elements.</param>
		/// <exception cref="ArgumentNullException">Thrown when <paramref name="values"/> is <c>null</c>.</exception>
		/// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="values"/> contains more or less than 4 elements.</exception>
		public RectangleL(Span<long> values)
		{
			if (values == null)
				throw new ArgumentNullException("values");
			if (values.Length < 4)
				throw new ArgumentOutOfRangeException("values", "There must be at least four input values for RectangleL.");
		...
		/// <summary>Initializes a new instance of <see cref="RectangleL"/> from a an unsafe pointer.</summary>
		...
		public unsafe RectangleL(long* ptrValues)
		{
			if (ptrValues == null)
