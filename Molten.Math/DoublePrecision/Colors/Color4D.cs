...
namespace Molten.DoublePrecision
{
    ...
    [DataContract]
    public struct Color4D : IEquatable<Color4D>, IFormattable, IVector<double>
    {
        ...
        /// </summary>
        public bool IsZero => R == 0D && G == 0D && B == 0D && A == 0D;
...
#region Indexers
		...
		/// <value>The value of the <see cref="Color4D"/> component, depending on the index.</value>
		...
		public unsafe double this[int index]
		{
			...
			{
				if(index < 0 || index > 3)
					throw new IndexOutOfRangeException("index for Color4D must be between 0 and 3, inclusive.");
