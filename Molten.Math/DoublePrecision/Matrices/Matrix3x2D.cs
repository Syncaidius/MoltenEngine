...
namespace Molten.DoublePrecision
{
	...
	public partial struct Matrix3x2D : IEquatable<Matrix3x2D>, IFormattable, ITransposableMatrix<Matrix3x2D, Matrix2x3D>, IMatrix<double>
    {
		...
		public unsafe double this[int index]
		{
            ...
            {
                if(index > 5 || index < 0)
                    throw new IndexOutOfRangeException("Index for Matrix3x2D must be between from 0 to 5, inclusive.");
		...
		public unsafe double this[uint index]
		{
            ...
            {
                if(index > 5)
                    throw new IndexOutOfRangeException("Index for Matrix3x2D must less than 6.");
        ...
        public unsafe double this[int row, int column]
        {
            ...
            {
                if (row < 0 || row > 2)
                    throw new ArgumentOutOfRangeException("row", "Rolumns for Matrix3x2D run from 0 to 2, inclusive.");
