...
public partial struct Matrix2x3D : IEquatable<Matrix2x3D>, IFormattable, ITransposableMatrix<Matrix2x3D, Matrix3x2D>, IMatrix<double>
{
    ...
    public void TransposeTo(out Matrix3x2D result)
    {
        TransposeTo(ref this, out result);
    }
      
    /// <summary>
    /// Transposes the current <see cref="Matrix2x3D"/> in-place, to a <see cref="Matrix3x2D"/>.
    /// </summary>
    public Matrix3x2D TransposeTo()
    {
        TransposeTo(ref this, out Matrix3x2D result);
        return result;
    }
    ...
    public static void TransposeTo(ref Matrix2x3D matrix, out Matrix3x2D result)
    {
    ...
    public static Matrix3x2D TransposeTo(Matrix2x3D value)
    {
        TransposeTo(ref value, out Matrix3x2D result);
        return result;
    }
	...
	/// <value>The value of the <see cref="Matrix2x3D"/> component, depending on the index.</value>
	...
	public unsafe double this[int index]
	{
		...
		{
			if(index < 0 || index > 5)
				throw new IndexOutOfRangeException("index for Matrix2x3D must be between 0 and 5, inclusive.");
	...
	public unsafe double this[int row, int column]
	{
		...
		{
			if(row < 0 || row > 5)
				throw new IndexOutOfRangeException("row for Matrix2x3D must be between 0 and 5, inclusive.");

			if(column < 0 || column > 5)
				throw new IndexOutOfRangeException("column for Matrix2x3D must be between 0 and 5, inclusive.");
