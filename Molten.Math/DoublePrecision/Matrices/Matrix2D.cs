...
[DataContract]
public partial struct Matrix2D : IEquatable<Matrix2D>, IFormattable, ITransposableMatrix<Matrix2D, Matrix2D>, IUniformMatrix<double>
{
    /// <summary>
    ...
    public void TransposeTo(out Matrix2D result)
    {
        TransposeTo(ref this, out result);
    }
      
    /// <summary>
    /// Transposes the current <see cref="Matrix2D"/> in-place, to a <see cref="Matrix2D"/>.
    /// </summary>
    public Matrix2D TransposeTo()
    {
        TransposeTo(ref this, out Matrix2D result);
        return result;
    }
    ...
    public static void TransposeTo(ref Matrix2D matrix, out Matrix2D result)
    {
    ...
    public static Matrix2D TransposeTo(Matrix2D value)
    {
        TransposeTo(ref value, out Matrix2D result);
        return result;
    }
	...
	/// <value>The value of the <see cref="Matrix2D"/> component, depending on the index.</value>
	...
	public unsafe double this[int index]
	{
		...
		{
			if(index < 0 || index > 3)
				throw new IndexOutOfRangeException("index for Matrix2D must be between 0 and 3, inclusive.");
	...
	/// <summary> Gets or sets the component at the specified index. </summary>
	/// <value>The value of the <see cref="Matrix2D"/> component, depending on the index.</value>
	/// <param name="row">The index of the row component to access, ranging from 0 to 1, inclusive.</param>
	...
	public unsafe double this[int row, int column]
	{
		...
		{
			if(row < 0 || row > 3)
				throw new IndexOutOfRangeException("row for Matrix2D must be between 0 and 3, inclusive.");

			if(column < 0 || column > 3)
				throw new IndexOutOfRangeException("column for Matrix2D must be between 0 and 3, inclusive.");
