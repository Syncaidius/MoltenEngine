...
namespace Molten.DoublePrecision
{
	...
	public partial struct Vector3D : IFormattable, ISignedVector<Vector3D, double>, IEquatable<Vector3D>
	{
        ...
        /// </summary>
        public bool IsZero => X == 0D && Y == 0D && Z == 0D;
...
#region Constructors
		...
		///<summary>Creates a new instance of <see cref="Vector3D"/>, using a <see cref="Vector2D"/> to populate the first 2 components.</summary>
...
#region Tuples
        ...
        /// <summary>
        /// Constructs a <see cref="Vector3D"/> from 3 component values.
        /// </summary>
...
#region Indexers
		...
		/// <value>The value of the <see cref="Vector3D"/> component, depending on the index.</value>
		...
		public unsafe double this[int index]
		{
			...
			{
				if(index < 0 || index > 2)
					throw new IndexOutOfRangeException("index for Vector3D must be between 0 and 2, inclusive.");
