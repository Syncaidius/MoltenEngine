...
[DataContract]
public partial struct Vector2L : IFormattable, ISignedVector<Vector2L, long>, IEquatable<Vector2L>
{
	...
	public static readonly Vector2L UnitX = new Vector2L(1L, 0L);

	/// <summary>The Y unit <see cref="Vector2L"/>.</summary>
	public static readonly Vector2L UnitY = new Vector2L(0L, 1L);
	...
	/// <summary>A fixed array mapped to the same memory space as the individual <see cref="Vector2L"/> components.</summary>
	[IgnoreDataMember]
	[FieldOffset(0)]
	public unsafe fixed long Values[2];

    /// <summary>
    /// Gets a value indicting whether this vector is zero
    /// </summary>
    public bool IsZero => X == 0L && Y == 0L;

#region Constructors
	/// <summary>
	/// Initializes a new instance of <see cref="Vector2L"/>.
	/// </summary>
	...
	/// <summary>Initializes a new instance of <see cref="Vector2L"/>.</summary>
	...
	/// <summary>Initializes a new instance of <see cref="Vector2L"/> from an array.</summary>
	...
	public unsafe Vector2L(long[] values)
	{
		if (values == null)
			throw new ArgumentNullException("values");
		if (values.Length < 2)
			throw new ArgumentOutOfRangeException("values", "There must be at least 2 input values for Vector2L.");

		fixed (long* src = values)
		{
			fixed (long* dst = Values)
				Unsafe.CopyBlock(src, dst, (sizeof(long) * 2));
		}
	}
	/// <summary>Initializes a new instance of <see cref="Vector2L"/> from a span.</summary>
	/// <param name="values">The values to assign to the X, Y components of the color. This must be an array with at least 2 elements.</param>
	/// <exception cref="ArgumentNullException">Thrown when <paramref name="values"/> is <c>null</c>.</exception>
	/// <exception cref="ArgumentOutOfRangeException">Thrown when <paramref name="values"/> contains more or less than 2 elements.</exception>
	public Vector2L(Span<long> values)
	{
		if (values == null)
			throw new ArgumentNullException("values");
		if (values.Length < 2)
	...
	/// <summary>Initializes a new instance of <see cref="Vector2L"/> from a an unsafe pointer.</summary>
	...
	public unsafe Vector2L(long* ptrValues)
	{
		if (ptrValues == null)
...
#region Tuples
    ...
    /// <summary>
    /// Constructs a <see cref="Vector2L"/> from 2 component values.
    /// </summary>
    /// <param name="tuple">The 2-component tuple containing the values.</param>
    public static implicit operator Vector2L((long x, long y) tuple)
    {
        return new Vector2L(tuple.x, tuple.y);
    }
#endregion
    ...
    /// <param name="min">The minimum value of each component.</param>
    /// <param name="max">The maximum value of each component.</param>
    public void Clamp(ref Vector2L min, ref Vector2L max)
    {
...
#region To-String
	/// <summary>
    /// Returns a <see cref="string"/> that represents this <see cref="Vector2L"/>.
    /// </summary>
    /// <param name="format">The format.</param>
    /// <returns>
    /// A <see cref="string"/> that represents this <see cref="Vector2L"/>.
    /// </returns>
...
#region Static Methods
    ...
    /// <param name="amount">Value between 0 and 1 indicating the weight of <paramref name="end"/>.</param>
    /// <param name="result">The output for the resultant <see cref="Vector2L"/>.</param>
    /// <remarks>
    ...
    public static Vector2L Reflect(Vector2L vector, Vector2L normal)
    {
...
#region Indexers
	...
	/// <value>The value of the <see cref="Vector2L"/> component, depending on the index.</value>
	...
	public unsafe long this[int index]
	{
		...
		{
			if(index < 0 || index > 1)
				throw new IndexOutOfRangeException("index for Vector2L must be between 0 and 1, inclusive.");
...
#region Casts - vectors
	...
	public static explicit operator SByte2(Vector2L value)
	{
		return new SByte2((sbyte)value.X, (sbyte)value.Y);
	}

	///<summary>Casts a <see cref="Vector2L"/> to a <see cref="SByte3"/>.</summary>
	public static explicit operator SByte3(Vector2L value)
	{
		return new SByte3((sbyte)value.X, (sbyte)value.Y, (sbyte)1);
	}

	///<summary>Casts a <see cref="Vector2L"/> to a <see cref="SByte4"/>.</summary>
	public static explicit operator SByte4(Vector2L value)
	{
	...
	public static explicit operator Byte2(Vector2L value)
	{
		return new Byte2((byte)value.X, (byte)value.Y);
	}

	///<summary>Casts a <see cref="Vector2L"/> to a <see cref="Byte3"/>.</summary>
	public static explicit operator Byte3(Vector2L value)
	{
		return new Byte3((byte)value.X, (byte)value.Y, (byte)1);
	}

	///<summary>Casts a <see cref="Vector2L"/> to a <see cref="Byte4"/>.</summary>
	public static explicit operator Byte4(Vector2L value)
	{
	...
	///<summary>Casts a <see cref="Vector2L"/> to a <see cref="Vector3I"/>.</summary>
	public static explicit operator Vector3I(Vector2L value)
	{
		return new Vector3I((int)value.X, (int)value.Y, 1);
	}

	///<summary>Casts a <see cref="Vector2L"/> to a <see cref="Vector4I"/>.</summary>
	public static explicit operator Vector4I(Vector2L value)
	{
	...
	///<summary>Casts a <see cref="Vector2L"/> to a <see cref="Vector3UI"/>.</summary>
	public static explicit operator Vector3UI(Vector2L value)
	{
		return new Vector3UI((uint)value.X, (uint)value.Y, 1U);
	}

	///<summary>Casts a <see cref="Vector2L"/> to a <see cref="Vector4UI"/>.</summary>
	public static explicit operator Vector4UI(Vector2L value)
	{
	...
	///<summary>Casts a <see cref="Vector2L"/> to a <see cref="Vector3S"/>.</summary>
	public static explicit operator Vector3S(Vector2L value)
	{
		return new Vector3S((short)value.X, (short)value.Y, (short)1);
	}

	///<summary>Casts a <see cref="Vector2L"/> to a <see cref="Vector4S"/>.</summary>
	public static explicit operator Vector4S(Vector2L value)
	{
	...
	///<summary>Casts a <see cref="Vector2L"/> to a <see cref="Vector3US"/>.</summary>
	public static explicit operator Vector3US(Vector2L value)
	{
		return new Vector3US((ushort)value.X, (ushort)value.Y, (ushort)1);
	}

	///<summary>Casts a <see cref="Vector2L"/> to a <see cref="Vector4US"/>.</summary>
	public static explicit operator Vector4US(Vector2L value)
	{
	...
	///<summary>Casts a <see cref="Vector2L"/> to a <see cref="Vector3UL"/>.</summary>
	public static explicit operator Vector3UL(Vector2L value)
	{
		return new Vector3UL((ulong)value.X, (ulong)value.Y, 1UL);
	}

	///<summary>Casts a <see cref="Vector2L"/> to a <see cref="Vector4UL"/>.</summary>
	public static explicit operator Vector4UL(Vector2L value)
	{
		return new Vector4UL((ulong)value.X, (ulong)value.Y, 1UL, 1UL);
	}

	///<summary>Casts a <see cref="Vector2L"/> to a <see cref="Vector2F"/>.</summary>
	public static explicit operator Vector2F(Vector2L value)
	{
		return new Vector2F((float)value.X, (float)value.Y);
	}

	///<summary>Casts a <see cref="Vector2L"/> to a <see cref="Vector3F"/>.</summary>
	public static explicit operator Vector3F(Vector2L value)
	{
		return new Vector3F((float)value.X, (float)value.Y, 1F);
	}

	///<summary>Casts a <see cref="Vector2L"/> to a <see cref="Vector4F"/>.</summary>
	public static explicit operator Vector4F(Vector2L value)
	{
	...
	///<summary>Casts a <see cref="Vector2L"/> to a <see cref="Vector3D"/>.</summary>
	public static explicit operator Vector3D(Vector2L value)
	{
		return new Vector3D((double)value.X, (double)value.Y, 1D);
	}

	///<summary>Casts a <see cref="Vector2L"/> to a <see cref="Vector4D"/>.</summary>
	public static explicit operator Vector4D(Vector2L value)
	{
