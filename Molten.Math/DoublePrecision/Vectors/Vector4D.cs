...
namespace Molten.DoublePrecision
{
	...
	public partial struct Vector4D : IFormattable, ISignedVector<Vector4D, double>, IEquatable<Vector4D>
	{
		...
		/// <summary>A fixed array mapped to the same memory space as the individual <see cref="Vector4D"/> components.</summary>
		[IgnoreDataMember]
		[FieldOffset(0)]
        ...
        /// </summary>
        public bool IsZero => X == 0D && Y == 0D && Z == 0D && W == 0D;
...
#region Constructors
		...
		public unsafe Vector4D(double[] values)
		{
			if (values == null)
				throw new ArgumentNullException("values");
			if (values.Length < 4)
				throw new ArgumentOutOfRangeException("values", "There must be at least 4 input values for Vector4D.");
		...
		///<summary>Creates a new instance of <see cref="Vector4D"/>, using a <see cref="Vector2D"/> to populate the first 2 components.</summary>
		...
		///<summary>Creates a new instance of <see cref="Vector4D"/>, using a <see cref="Vector3D"/> to populate the first 3 components.</summary>
...
#region Tuples
        ...
        /// <summary>
        /// Constructs a <see cref="Vector4D"/> from 4 component values.
        /// </summary>
        /// <param name="tuple">The 4-component tuple containing the values.</param>
        public static implicit operator Vector4D((double x, double y, double z, double w) tuple)
        {
            return new Vector4D(tuple.x, tuple.y, tuple.z, tuple.w);
        }
#endregion
...
#region Indexers
		...
		/// <value>The value of the <see cref="Vector4D"/> component, depending on the index.</value>
		...
		public unsafe double this[int index]
		{
			...
			{
				if(index < 0 || index > 3)
					throw new IndexOutOfRangeException("index for Vector4D must be between 0 and 3, inclusive.");
