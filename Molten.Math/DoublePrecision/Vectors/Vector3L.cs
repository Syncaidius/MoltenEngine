...
#region Constructors
		...
		public Vector3L(long[] values)
		{
			...
			if (values.Length < 3)
				throw new ArgumentOutOfRangeException("values", "There must be at least three input values for Vector3L.");
...
#region Indexers
		...
		public unsafe long this[int index]
		{
            ...
            {
                if(index > 2 || index < 0)
                    throw new IndexOutOfRangeException("Index for Vector3L must be between from 0 to 2, inclusive.");
