...
public partial struct Vector4L : IFormattable, ISignedVector<Vector4L, long>, IEquatable<Vector4L>
{
	...
	/// <summary>A fixed array mapped to the same memory space as the individual <see cref="Vector4L"/> components.</summary>
	[IgnoreDataMember]
	[FieldOffset(0)]
    ...
    /// </summary>
    public bool IsZero => X == 0L && Y == 0L && Z == 0L && W == 0L;
...
#region Constructors
	...
	public unsafe Vector4L(long[] values)
	{
		if (values == null)
			throw new ArgumentNullException("values");
		if (values.Length < 4)
			throw new ArgumentOutOfRangeException("values", "There must be at least 4 input values for Vector4L.");

		fixed (long* src = values)
		{
			fixed (long* dst = Values)
				Unsafe.CopyBlock(src, dst, (sizeof(long) * 4));
		}
	}
	...
	public unsafe Vector4L(long* ptrValues)
	{
		...
		fixed (long* dst = Values)
			Unsafe.CopyBlock(ptrValues, dst, (sizeof(long) * 4));
	}

	///<summary>Creates a new instance of <see cref="Vector4L"/>, using a <see cref="Vector2L"/> to populate the first 2 components.</summary>
	...
	///<summary>Creates a new instance of <see cref="Vector4L"/>, using a <see cref="Vector3L"/> to populate the first 3 components.</summary>
...
#region Tuples
    ...
    /// <summary>
    /// Constructs a <see cref="Vector4L"/> from 4 component values.
    /// </summary>
    /// <param name="tuple">The 4-component tuple containing the values.</param>
    public static implicit operator Vector4L((long x, long y, long z, long w) tuple)
    {
        return new Vector4L(tuple.x, tuple.y, tuple.z, tuple.w);
    }
#endregion
    ...
    /// <param name="min">The minimum value of each component.</param>
    /// <param name="max">The maximum value of each component.</param>
    public void Clamp(ref Vector4L min, ref Vector4L max)
    {
...
#region To-String
	/// <summary>
    /// Returns a <see cref="string"/> that represents this <see cref="Vector4L"/>.
    /// </summary>
    /// <param name="format">The format.</param>
    /// <returns>
    /// A <see cref="string"/> that represents this <see cref="Vector4L"/>.
    /// </returns>
...
#region Add operators
	...
	///<param name="result">Output for the result of the operation.</param>
	public static void Add(ref Vector4L a, long b, out Vector4L result)
	{
		result.X = a.X + b;
		result.Y = a.Y + b;
		result.Z = a.Z + b;
	...
	///<returns>The result of the operation.</returns>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Vector4L operator +(Vector4L a, long b)
	{
		Add(ref a, b, out Vector4L result);
		return result;
	}
	...
	///<returns>The result of the operation.</returns>
	[MethodImpl(MethodImplOptions.AggressiveInlining)]
	public static Vector4L operator +(long a, Vector4L b)
	{
		Add(ref b, a, out Vector4L result);
		return result;
	}
...
#region Subtract operators
	...
	///<param name="a">The first <see cref="Vector4L"/> to subtract.</param>
	///<param name="b">The second <see cref="Vector4L"/> to subtract.</param>
	///<param name="result">Output for the result of the operation.</param>
	...
	///<param name="result">Output for the result of the operation.</param>
	public static void Subtract(ref Vector4L a, long b, out Vector4L result)
	{
		result.X = a.X - b;
		result.Y = a.Y - b;
		result.Z = a.Z - b;
	...
	public static Vector4L operator -(Vector4L a, long b)
	{
		Subtract(ref a, b, out Vector4L result);
		return result;
	}
	...
	public static Vector4L operator -(long a, Vector4L b)
	{
		Subtract(ref b, a, out Vector4L result);
		return result;
	}
...
#region division operators
	...
	///<param name="a">The first <see cref="Vector4L"/> to divide.</param>
	///<param name="b">The second <see cref="Vector4L"/> to divide.</param>
	///<param name="result">Output for the result of the operation.</param>
	...
	///<param name="result">Output for the result of the operation.</param>
	public static void Divide(ref Vector4L a, long b, out Vector4L result)
	{
		result.X = a.X / b;
		result.Y = a.Y / b;
		result.Z = a.Z / b;
	...
	public static Vector4L operator /(Vector4L a, long b)
	{
		Divide(ref a, b, out Vector4L result);
		return result;
	}
	...
	public static Vector4L operator /(long a, Vector4L b)
	{
		Divide(ref b, a, out Vector4L result);
		return result;
	}
...
#region Multiply operators
	...
	///<param name="a">The first <see cref="Vector4L"/> to multiply.</param>
	///<param name="b">The second <see cref="Vector4L"/> to multiply.</param>
	///<param name="result">Output for the result of the operation.</param>
	...
	///<param name="result">Output for the result of the operation.</param>
	public static void Multiply(ref Vector4L a, long b, out Vector4L result)
	{
		result.X = a.X * b;
		result.Y = a.Y * b;
		result.Z = a.Z * b;
	...
	public static Vector4L operator *(Vector4L a, long b)
	{
		Multiply(ref a, b, out Vector4L result);
		return result;
	}
	...
	public static Vector4L operator *(long a, Vector4L b)
	{
		Multiply(ref b, a, out Vector4L result);
		return result;
	}
...
#region Indexers
	...
	/// <value>The value of the <see cref="Vector4L"/> component, depending on the index.</value>
	...
	public unsafe long this[int index]
	{
		...
		{
			if(index < 0 || index > 3)
				throw new IndexOutOfRangeException("index for Vector4L must be between 0 and 3, inclusive.");
...
#region Casts - vectors
	///<summary>Casts a <see cref="Vector4L"/> to a <see cref="SByte2"/>.</summary>
	public static explicit operator SByte2(Vector4L value)
	{
		return new SByte2((sbyte)value.X, (sbyte)value.Y);
	}

	///<summary>Casts a <see cref="Vector4L"/> to a <see cref="SByte3"/>.</summary>
	...
	///<summary>Casts a <see cref="Vector4L"/> to a <see cref="Byte2"/>.</summary>
	public static explicit operator Byte2(Vector4L value)
	{
		return new Byte2((byte)value.X, (byte)value.Y);
	}

	///<summary>Casts a <see cref="Vector4L"/> to a <see cref="Byte3"/>.</summary>
	...
	///<summary>Casts a <see cref="Vector4L"/> to a <see cref="Vector2I"/>.</summary>
	public static explicit operator Vector2I(Vector4L value)
	{
		return new Vector2I((int)value.X, (int)value.Y);
	}

	///<summary>Casts a <see cref="Vector4L"/> to a <see cref="Vector3I"/>.</summary>
	...
	///<summary>Casts a <see cref="Vector4L"/> to a <see cref="Vector2UI"/>.</summary>
	public static explicit operator Vector2UI(Vector4L value)
	{
		return new Vector2UI((uint)value.X, (uint)value.Y);
	}

	///<summary>Casts a <see cref="Vector4L"/> to a <see cref="Vector3UI"/>.</summary>
	...
	///<summary>Casts a <see cref="Vector4L"/> to a <see cref="Vector2S"/>.</summary>
	public static explicit operator Vector2S(Vector4L value)
	{
		return new Vector2S((short)value.X, (short)value.Y);
	}

	///<summary>Casts a <see cref="Vector4L"/> to a <see cref="Vector3S"/>.</summary>
	...
	///<summary>Casts a <see cref="Vector4L"/> to a <see cref="Vector2US"/>.</summary>
	public static explicit operator Vector2US(Vector4L value)
	{
		return new Vector2US((ushort)value.X, (ushort)value.Y);
	}

	///<summary>Casts a <see cref="Vector4L"/> to a <see cref="Vector3US"/>.</summary>
	...
	///<summary>Casts a <see cref="Vector4L"/> to a <see cref="Vector2UL"/>.</summary>
	public static explicit operator Vector2UL(Vector4L value)
	{
		return new Vector2UL((ulong)value.X, (ulong)value.Y);
	}

	///<summary>Casts a <see cref="Vector4L"/> to a <see cref="Vector3UL"/>.</summary>
	...
	///<summary>Casts a <see cref="Vector4L"/> to a <see cref="Vector2F"/>.</summary>
	public static explicit operator Vector2F(Vector4L value)
	{
		return new Vector2F((float)value.X, (float)value.Y);
	}

	///<summary>Casts a <see cref="Vector4L"/> to a <see cref="Vector3F"/>.</summary>
	...
	///<summary>Casts a <see cref="Vector4L"/> to a <see cref="Vector2D"/>.</summary>
	public static explicit operator Vector2D(Vector4L value)
	{
		return new Vector2D((double)value.X, (double)value.Y);
	}

	///<summary>Casts a <see cref="Vector4L"/> to a <see cref="Vector3D"/>.</summary>
