...
namespace Molten.DoublePrecision
{
    ...
    [DataContract]
	public partial struct Vector4UL : IFormattable, IUnsignedVector<Vector4UL, ulong>, IEquatable<Vector4UL>
	{
		...
		/// <summary>A fixed array mapped to the same memory space as the individual <see cref="Vector4UL"/> components.</summary>
		[IgnoreDataMember]
		[FieldOffset(0)]
        ...
        /// </summary>
        public bool IsZero => X == 0UL && Y == 0UL && Z == 0UL && W == 0UL;
...
#region Constructors
		...
		public unsafe Vector4UL(ulong[] values)
		{
			if (values == null)
				throw new ArgumentNullException("values");
			if (values.Length < 4)
				throw new ArgumentOutOfRangeException("values", "There must be at least 4 input values for Vector4UL.");
		...
		public unsafe Vector4UL(ulong* ptrValues)
		{
			...
			fixed (ulong* dst = Values)
				Unsafe.CopyBlock(ptrValues, dst, (sizeof(ulong) * 4));
		}

		///<summary>Creates a new instance of <see cref="Vector4UL"/>, using a <see cref="Vector2UL"/> to populate the first 2 components.</summary>
		...
		///<summary>Creates a new instance of <see cref="Vector4UL"/>, using a <see cref="Vector3UL"/> to populate the first 3 components.</summary>
...
#region Tuples
        ...
        /// <summary>
        /// Constructs a <see cref="Vector4UL"/> from 4 component values.
        /// </summary>
        /// <param name="tuple">The 4-component tuple containing the values.</param>
        public static implicit operator Vector4UL((ulong x, ulong y, ulong z, ulong w) tuple)
        {
            return new Vector4UL(tuple.x, tuple.y, tuple.z, tuple.w);
        }
#endregion
...
#region Static Methods
        ...
        public static Vector4UL Reflect(Vector4UL vector, Vector4UL normal)
        {
...
#region Indexers
		...
		/// <value>The value of the <see cref="Vector4UL"/> component, depending on the index.</value>
		...
		public unsafe ulong this[int index]
		{
			...
			{
				if(index < 0 || index > 3)
					throw new IndexOutOfRangeException("index for Vector4UL must be between 0 and 3, inclusive.");
