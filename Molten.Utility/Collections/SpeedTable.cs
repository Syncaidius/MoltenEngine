...
namespace Molten.Collections
{
    ...
    public class SpeedTable<T>
    {
        ...
        public SpeedTable(int initialCapacity = 5, ExpansionMode expansionMode = ExpansionMode.Multiply, int expansionValue = 2)
        {
        ...
        /// <param name="item">The item to add.</param>
        /// <returns>The index of the item after adding it to the list.</returns>
        public int AddFast(string key, T item)
        {
            int id = _itemCount;
            _itemCount++;
        ...
        public void RemoveByKey(string key)
        {
            ...
            if (index > -1)
                ...
                throw new Exception("SpeedTable -- RemoveByKey: Key not found.");
        }
        ...
        public T this[string key]
        {
            get
            {
                ...
                throw new Exception("SpeedDictionary: Key '" + key + "'was not found.");
#else
                return default(T);
#endif
            }
