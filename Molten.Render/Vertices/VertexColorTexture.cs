...
namespace Molten.Graphics
{
    ...
    public struct VertexColorTexture : IVertexType
    {
        ...
        public VertexColorTexture(Vector4 position, Color color, Vector2 textureCoordinates)
        {
        ...
        public VertexColorTexture(Vector3 position, Color color, Vector2 textureCoordinates)
        {
