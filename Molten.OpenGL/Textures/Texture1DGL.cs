...
namespace Molten.Graphics
{
    public class Texture1DGL : TextureBaseGL, ITexture
    {
        public Texture1DGL(Texture1DGL descTexture, TextureFlags flags) :
            this(descTexture.Renderer as RendererGL, descTexture.Width, descTexture.DataFormat, descTexture.MipMapCount, descTexture.ArraySize, descTexture.Flags)
        {
        }
        ...
        protected unsafe override void CreateResource(ref uint id, TextureTarget target, bool isResizing)
        {
            ...
            for (int i = 0; i < MipMapCount; i++)
                Gl.TexImage1D(target, i, DataFormat.ToInternal(), Width, 0, PixelFormat.Rgba, PixelType.UnsignedByte, IntPtr.Zero);
        }
    }
}
